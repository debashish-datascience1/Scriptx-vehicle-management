...
class TransactionController extends Controller
{
    ...
    public function reportbank(){
        ...
        //         $t->prev =  $bankArr[$bank_id][count($bankArr[$bank_id])-1]['prev'];
        //         $t->grandtotal =  $bankArr[$bank_id][count($bankArr[$bank_id])-1]['gtotal'];
        //         // $bankKey = count($bankArr[$bank_id])==1 ? 0 : count($bankArr[$bank_id])-1;
        //         // $t->prev = $bankKey==0 ? 0 : $bankArr[$bank_id][$bankKey];
        //         // // $t->bank = $bankArr;
        //         // if($t->type==23){
        //         //     // $t->grandtotal = $index['transactions'][$k-1]->grandtotal+$t->total;
        //         //     $t->grandtotal = $bankArr[$bank_id][$bankKey]+$t->total;
        //         // }
        //         // else{
        //         //     $t->grandtotal = $bankArr[$bank_id][$bankKey]-$t->total;
        //         // }
        ...
        //         //         dd($bankArr);
        //         //         $bankKey = count($bankArr[$bank_id])==1 ? 0 : count($bankArr[$bank_id])-1;
        //         //         $t->prev = $bankArr[$bank_id][$bankKey];
        //         //     }else{
        //         //         $bankArr[$bank_id][] = $t->grandtotal;
        //         //         $t->prev = $bankArr[$bank_id][0];
        //         //     }
        ...
        // dd($bankArr);
        // dd($index);
        // return view('transactions.index',$index);
