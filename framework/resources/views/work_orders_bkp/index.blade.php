          ...
          @foreach($data as $row)
            <tr>
              ...
              <td>
                ...
                <br>
                <span class="badge badge-danger">{{strtoupper($row->vehicle['license_plate'])}}</span>
              </td>
              <td>
              ...
              <td> 
                <table class="table table-responsive table-bordered" style="display: table;">
                  ...
                  @endif
                  @if(!empty($row->sgst) || !empty($row->sgst))
                  <tr>
                    <th></th>
                    <td colspan="2"><label style="float: right;">{{Hyvikk::get('currency')}} {{Helper::properDecimals($row->price+$row->cgst_amt+$row->sgst_amt)}}</label></td>
                  </tr>
                  @endif
                </table>
              </td>
              {{--<td>
                 {{Hyvikk::get('currency')}} {{$row->cgst_amt}} @ {{$row->cgst}} %<br>
                ...
                <table class="table table-responsive table-bordered">
                  ...
                  <tr>
                    <th></th>
                    <td colspan="2"><span style="float: right;">{{Hyvikk::get('currency')}} {{Helper::properDecimals($row->cgst_amt+$row->sgst_amt)}}</span></td>
                  </tr>
                  @endif
                </table>
                @else
