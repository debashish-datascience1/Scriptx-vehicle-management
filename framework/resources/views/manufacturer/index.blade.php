...
@endsection
@section("breadcrumb")
<li class="breadcrumb-item active">@lang('fleet.manufacturer')</li>
@endsection
@section('content')
<div class="row">
  <div class="col-md-12">
    ...
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">@lang('fleet.manufacturer') &nbsp;
          <a href="{{ route("manufacturer.create") }}" class="btn btn-success"> Add @lang('fleet.manufacturer') </a>
        </h3>
      </div>
        ...
        <table class="table" id="data_table" style="padding-bottom: 15px">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{$k+1}}</td>
              <td>{{$row->name}}</td>
              <td>{{Helper::getCanonicalDateTime($row->created_at,'default')}}</td>
              <td>
              <div class="btn-group">
                ...
                <div class="dropdown-menu custom" role="menu">
                  ...
                  <a class="dropdown-item" href="{{ url("admin/manufacturer/".$row->id."/edit")}}"> <span aria-hidden="true" class="fa fa-edit" style="color: #f0ad4e;"></span> @lang('fleet.edit')</a>
              ...
              {!! Form::open(['url' => 'admin/manufacturer/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]) !!}
