                ...
                <div class="card-body">
                    ...
                    <div class="row newrow">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                {!! Form::select('vendor', $vendors, $request['vendor'] ?? null, [
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                &nbsp; <br>
                                {!! Form::select('fuel_type', $fuel_types, $request['fuel_type'] ?? null, [
                                    'class' => 'form-control fullsize',
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                &nbsp;
                                {!! Form::select('order', ['DESC' => 'Descending', 'ASC' => 'Ascending'], $request['order'] ?? null, [
                                    'class' => 'form-control fullsize',
                                ]) !!}
                            </div>
                        </div>
                        <div class="col-md-1">
                            <div class="form-group">
                                {!! Form::label('by', __('By'), ['class' => 'form-label']) !!}
                                &nbsp;
                                {!! Form::select('by', ['date' => 'Date', 'vehicle' => 'Vehicle'], $request['by'] ?? null, [
                                    'class' => 'form-control fullsize',
                                ]) !!}
                            </div>
                        </div>
                    ...
                    <div class="row newrow">
                        <div class="col-md-12">
                            ...
                            <button type="submit" formaction="{{ url('admin/print-vendor-vehicle-fuel-report') }}"
                                formtarget="_blank" class="btn btn-danger"><i class="fa fa-print"></i>
                                @lang('fleet.print')</button>
                            <button type="submit" formaction="{{ url('admin/reports/export/vendor-report-export') }}"
                            ...
                            <tbody>
                                @foreach ($fuel as $k => $row)
                                    <tr>
                                        ...
                                        @endif
                                        <td>{{ $row->vehicle_data->make }}-{{ $row->vehicle_data->model }}-<strong>{{ strtoupper($row->vehicle_data->license_plate) }}</strong>
                                        </td>
                                        <td>
                                        ...
                                        <td>{{ Hyvikk::get('currency') }}
                                            {{ bcdiv($row->qty * $row->cost_per_unit, 1, 2) }}
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <th style="float:right">Total Amount : {{ Hyvikk::get('currency') }}
                                    {{ bcdiv($fuelTotal, 1, 2) }}</th>
                                <th style="float:right">Total Fuel : {{ bcdiv($fuelQtySum, 1, 2) }} ltr</th>
                            </tr>
                        </table>
                    </div>
                </div>
