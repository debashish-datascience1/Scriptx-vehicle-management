  ...
  <div class="col-md-12">
    <div class="card card-success">
      <div class="card-header with-border">
        <h3 class="card-title">Add @lang('fleet.unit')</h3>
      </div>
      ...
      <div class="card-body">
        ...
        {!! Form::open(['route' => 'unit.store','files'=>true,'method'=>'post']) !!}
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('name', __('fleet.name'), ['class' => 'form-label required']) !!}
              {!! Form::text('name',null,['class' => 'form-control','id'=>'name','required','placeholder'=>'Enter Unit']) !!}
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('short_name', __('fleet.short_name'), ['class' => 'form-label required']) !!}
              {!! Form::text('short_name',null,['class' => 'form-control','id'=>'short_name','required','placeholder'=>'Enter Unit Short Name']) !!}
            </div>
          </div>
          <div class="col-md-12">
