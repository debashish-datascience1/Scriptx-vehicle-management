...
@endsection
@section("breadcrumb")
<li class="breadcrumb-item active">@lang('fleet.unit')</li>
@endsection
@section('content')
<div class="row">
  <div class="col-md-12">
    ...
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">@lang('fleet.unit') &nbsp;
          <a href="{{ route("unit.create") }}" class="btn btn-success"> Add @lang('fleet.unit') </a>
        </h3>
      </div>
            ...
            <tr>
              ...
              <div class="btn-group">
                ...
                <div class="dropdown-menu custom" role="menu">
                  ...
                  <a class="dropdown-item" href="{{ url("admin/unit/".$row->id."/edit")}}"> <span aria-hidden="true" class="fa fa-edit" style="color: #f0ad4e;"></span> @lang('fleet.edit')</a>
              ...
              {!! Form::open(['url' => 'admin/unit/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]) !!}
