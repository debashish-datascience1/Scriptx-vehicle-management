      ...
      <div class="card-body">
        <div class="nav-tabs-custom">
          <ul class="nav nav-pills custom">
            <li class="nav-item"><a class="nav-link active" href="#info-tab" data-toggle="tab"> @lang('fleet.general_info') </a></li>
            <li class="nav-item"><a class="nav-link" href="#insurance" data-toggle="tab"> @lang('fleet.vehicleDocs') </a></li>
            <li class="nav-item"><a class="nav-link" href="#acq-tab" data-toggle="tab"> @lang('fleet.purchase_info') </a></li>
            <li class="nav-item"><a class="nav-link" href="#driver" data-toggle="tab"> @lang('fleet.assign_driver') </a></li>
          </ul>
        </div>
            ...
            <div class="row card-body">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-6">
                  {!! Form::text('year', Helper::indianDateFormat($vehicle->year),['class' => 'form-control','required','readonly']) !!}
                  </div>
                </div>
            ...
            <div class="row card-body">
              <div class="col-md-4">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group date">
                    <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-calendar"></i></span></div>
                    {!! Form::text('exp_date',!empty($vehicle->getMeta('ins_exp_date')) ? Helper::indianDateFormat($vehicle->getMeta('ins_exp_date')) : null,['class' => 'form-control','required','readonly','style'=>$insurance_NewExpiryDate->status ? 'pointer-events:none' : '']) !!}
                ...
                <div class="form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      {!!Form::select('insurance_duration_unit',Helper::durationUnits(),$vehicle->getMeta('insurance_duration_unit'),['class'=>'form-control','placeholder'=>'Select Duration','id'=>'insurance_duration_unit'])!!}
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-4">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group date">
                    <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-calendar"></i></span></div>
                    {!! Form::text('fitness_expdate',!empty($vehicle->getMeta('fitness_expdate')) ? Helper::indianDateFormat($vehicle->getMeta('fitness_expdate')) : null,['class' => 'form-control','required','readonly', 'style'=>$fitness_NewExpiryDate->status ? 'pointer-events:none' : '']) !!}
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      {!!Form::select('fitness_duration_unit',Helper::durationUnits(),$vehicle->getMeta('fitness_duration_unit'),['class'=>'form-control','placeholder'=>'Select Duration','id'=>'fitness_duration_unit'])!!}
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-4">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group date">
                    <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-calendar"></i></span></div>
                    {!! Form::text('road_expdate', !empty($vehicle->getMeta('road_expdate')) ? Helper::indianDateFormat($vehicle->getMeta('road_expdate')) : null,['class' => 'form-control','required','readonly','style'=> $roadtax_NewExpiryDate->status ? 'pointer-events:none' : '']) !!}
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      {!!Form::select('roadtax_duration_unit',Helper::durationUnits(),$vehicle->getMeta('roadtax_duration_unit'),['class'=>'form-control','placeholder'=>'Select Duration','id'=>'roadtax_duration_unit'])!!}
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="row card-body">
              <div class="col-md-4">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group date">
                    <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-calendar"></i></span></div>
                    {!! Form::text('permit_expdate',!empty($vehicle->getMeta('permit_expdate')) ? Helper::indianDateFormat($vehicle->getMeta('permit_expdate')) :null,['class' => 'form-control','required','readonly','style'=>$permit_NewExpiryDate->status ? 'pointer-events:none' : '']) !!}
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      {!!Form::select('permit_duration_unit',Helper::durationUnits(),$vehicle->getMeta('permit_duration_unit'),['class'=>'form-control','placeholder'=>'Select Duration','id'=>'permit_duration_unit'])!!}
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-4">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group date">
                    {{-- {{dd($pollution_NewExpiryDate)}} --}}
                    <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-calendar"></i></span></div>
                    {!! Form::text('pollution_expdate', $pollution_NewExpiryDate->status ? Helper::indianDateFormat($pollution_NewExpiryDate->date) : Helper::indianDateFormat($vehicle->getMeta('pollution_expdate')),['class' => 'form-control','required','readonly','style'=>$pollution_NewExpiryDate->status ? 'pointer-events:none' : '']) !!}
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      {!!Form::select('pollution_duration_unit',Helper::durationUnits(),$vehicle->getMeta('pollution_duration_unit'),['class'=>'form-control','placeholder'=>'Select Duration','id'=>'pollution_duration_unit'])!!}
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="row card-body">
              <div class="col-md-2">
                  <div class="form-group" >
                    ...
                    <div class="col-xs-6">
                    {!! Form::text('purchase_date',!empty($purchase_info->purchase_date) ? Helper::indianDateFormat($purchase_info->purchase_date) : null,['class' => 'form-control','required','id'=>'purchase_date','readonly']) !!}
                    </div>
                  </div>
              </div>
              <div class="col-md-2">
                  <div class="form-group" >
                    ...
                    <div class="col-xs-6">
                    {!! Form::text('vehicle_cost',$purchase_info->vehicle_cost ?? "",['class' => 'form-control','required','onkeypress'=>'return isNumber(event,this)']) !!}
                    </div>
                  </div>
              </div>
              <div class="col-md-2">
                  <div class="form-group" >
                    ...
                    <div class="col-xs-6">
                    {!! Form::text('amount_paid',$purchase_info->amount_paid ?? "",['class' => 'form-control','required','onkeypress'=>'return isNumber(event,this)']) !!}
                    </div>
                  </div>
              </div>
              <div class="col-md-2">
                  <div class="form-group" >
                    {!! Form::label('bank', __('fleet.downpayment_bank'), ['class' => 'col-xs-5 control-label']) !!}
                    <div class="col-xs-6">
                    {!! Form::select('bank',$banks,$purchase_info->bank ?? "",['class' => 'form-control','required','placeholder'=>'Select Bank']) !!}
                    </div>
                  </div>
              </div>
              <div class="col-md-2">
                  <div class="form-group" >
                    {!! Form::label('method', __('fleet.downpayment_method'), ['class' => 'col-xs-5 control-label']) !!}
                    <div class="col-xs-6">
                    {!! Form::select('method',$methods,$purchase_info->method ?? "",['class' => 'form-control','required','placeholder'=>'Select Method']) !!}
                    </div>
                  </div>
              </div>
              <div class="col-md-2">
                <div class="form-group" >
                  {!! Form::label('reference_no', __('fleet.reference_no'), ['class' => 'col-xs-5 control-label']) !!}
                  <div class="col-xs-6">
                  {!! Form::text('reference_no',$purchase_info->reference_no ?? "",['class' => 'form-control','required','placeholder'=>'Enter Reference No.']) !!}
                  </div>
                </div>
            </div>
            </div>
                ...
                <div class="card-body">
                  <div class="row form-group">
                    <div class="col-md-2">
                      <div class="form-group" >
                        ...
                        <div class="col-xs-6">
                        {!! Form::text('loan_date',!empty($purchase_info->loan_date) ? Helper::indianDateFormat($purchase_info->loan_date) : null,['class' => 'form-control','required','id'=>'loan_date','readonly']) !!}
                        </div>
                      </div>
                    </div>
                    <div class="col-md-2">
                      <div class="form-group" >
                        ...
                        <div class="col-xs-6">
                        {!! Form::text('loan_amount',$purchase_info->loan_amount ?? "",['class' => 'form-control','required','onkeypress'=>'return isNumber(event,this)']) !!}
                        </div>
                      </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-2">
                      <div class="form-group" >
                        ...
                        <div class="col-xs-6">
                        {!! Form::text('emi_date',!empty($purchase_info->emi_date) ? Helper::indianDateFormat($purchase_info->emi_date) : null,['class' => 'form-control','required','readonly']) !!}
                        </div>
                      </div>
                    </div>
                    <div class="col-md-2">
                      <div class="form-group" >
                        ...
                        <div class="col-xs-6">
                        {!! Form::text('emi_amount',$purchase_info->emi_amount ?? "",['class' => 'form-control','required','onkeypress'=>'return isNumber(event,this)']) !!}
                    ...
                    <div class="col-md-2">
                      <div class="form-group" >
                        ...
                        <div class="col-xs-6">
                        {!! Form::text('loan_duration',$purchase_info->loan_duration ?? "",['class' => 'form-control','required','onkeypress'=>'return isWholeNumber(event)']) !!}
                    ...
                    <div class="col-md-2">
                      <div class="form-group" >
                        {!! Form::label('duration_unit', __('fleet.durationUnit'), ['class' => 'col-xs-5 control-label']) !!}
                        <div class="col-xs-6">
                        {!! Form::select('duration_unit',['months'=>'Months'],$purchase_info->duration_unit ?? "",['class' => 'form-control','required']) !!}
                        </div>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group" >
                        {!! Form::label('loan_about', __('fleet.loanRemarks'), ['class' => 'col-xs-5 control-label']) !!}
                        <div class="col-xs-6">
                        {!! Form::textarea('loan_about',$purchase_info->loan_about ?? "",['class' => 'form-control','placeholder'=>'About Loan...','style'=>'resize:none;height:120px;']) !!}
                        </div>
                      </div>
                    </div>
                    {{-- <div class="col-md-4">
                  ...
                  <div class="row form-group">
                    <div class="col-md-4">
                      <div class="form-group" >
                        <div class="col-xs-6">
                        {!! Form::submit(__('fleet.submit'), ['class' => 'btn btn-warning','id'=>'loan_submit']) !!}
                        </div>
                      </div>
                    </div>
                  </div>
