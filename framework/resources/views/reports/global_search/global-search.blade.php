...
<div class="row">
  <div class="col-md-12">
    <div class="card card-info">
      ...
      <div class="card-body">
        {!! Form::open(['route' => 'reports.global-search','method'=>'post','class'=>'form-block']) !!}
        <div class="row newrow">
          <div class="col-md-3">
            <div class="form-group">
              {!! Form::label('param_id', 'Search', ['class' => 'form-label']) !!}
              {!!Form::select('param_id',$params,$request['param_id'] ?? null,['class'=>'form-control fullsize','id'=>'param_id'])!!}
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
              {!! Form::label('vehicle_no', 'Vehicle(s)', ['class' => 'form-label']) !!}
              {!!Form::select('vehicle_no[]',$vehicles,$request['vehicle_no'] ?? null,['class'=>'form-control fullsize','id'=>'vehicle_no','multiple'=>'multiple','placeholder'=>'ALL','required'])!!}
              <i><small>Enter vehicle license plate</small></i>
            </div>
          </div>
          <div class="col-md-3">
						<div class="form-group">
							{!! Form::label('from_date','From',['class' => 'form-label dateShow']) !!}
							<div class="input-group">
								<div class="input-group-prepend">
								<span class="input-group-text"><i class="fa fa-calendar"></i></span></div>
								{!! Form::text('from_date',$request['from_date'] ?? null,['class' => 'form-control','placeholder'=>__('fleet.start_date'),'readonly']) !!}
							</div>
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							{!! Form::label('to_date','To',['class' => 'form-label dateShow']) !!}
							<div class="input-group">
							  <div class="input-group-prepend">
							  <span class="input-group-text"><i class="fa fa-calendar"></i></span></div>
							  {!! Form::text('to_date', $request['to_date'] ?? null,['class' => 'form-control','placeholder'=>__('fleet.end_date'),'readonly']) !!}
							</div>
						</div>
					</div>
        </div>
...
<div class="row">
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">
          {!! count($collection)>1 ? "Search Results" : "Search Result"!!}
        </h3>
      </div>
      <div class="card-body table-responsive">
        @if ($param_post==18)
          @include('reports.global_search.bookings')
        @elseif($param_post==20)
          @include('reports.global_search.fuel')
        @endif
