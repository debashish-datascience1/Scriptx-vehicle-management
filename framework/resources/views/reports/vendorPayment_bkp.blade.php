      ...
      <div class="card-body">
          ...
          <div class="col-md-4">
            <div class="form-group" style="margin-right: 10px">
              {!! Form::label('from', 'From', ['class' => 'form-label']) !!}
                  {!!Form::select('from',$from,$request['from'],['class'=>'form-control fullsize','placeholder'=>'From'])!!}
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group" style="margin-right: 10px">
              ...
              &nbsp; <br>
              {!!Form::select('payment_type',$payment_type,$request['payment_type'],['class'=>'form-control fullsize','placeholder'=>'Type'])!!}
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group" style="margin-right: 10px">
        ...
        <div class="row newrow">
          <div class="col-md-12">
            ...
            <button type="submit" formaction="{{url('admin/print-vendor-payment')}}" class="btn btn-danger" formtarget="_blank"><i class="fa fa-print"></i> @lang('fleet.print')</button>
          </div>
        </div>
          {!! Form::close() !!}
      </div>
        ...
        <table class="table table-bordered table-striped table-hover"  id="myTable">
          ...
          <tbody>
            ...
            <tr>
              <td>{{$k+1}}</td>
              @if(empty($request['from']))
              <td>{{$row->filtered_vendor->name}}</td>
              @endif
              <td>
              ...
              <td>{{Hyvikk::get('currency')}} {{$row->total}}
              </td>
            </tr>
            @endforeach
