                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('customer_id', $customers, $request['customer_id'] ?? null, [
                                    'class' => 'form-control',
                                    'id' => 'customer_id',
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <button type="submit" formaction="{{ url('admin/print-customer-payment') }}"
                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <div class="card-body table-responsive">
                            ...
                            <table class="table">
                                <tr>
                                    <th style="float:right">Opening Balance : {{ Hyvikk::get('currency') }}
                                        {{ bcdiv($opening_balance, 1, 2) }}</th>
                                </tr>
                            </table>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(".where_from").on("click", function() {
                ...
                console.log(id);
                console.log(partsw);
                $("#whereModal .modal-content").load('{{ url('admin/accounting/where_from') }}/' + id,
                    function(res) {
            ...
            $(".advance_for").on("click", function() {
                var id = $(this).data("id");
                $("#advanceForModal .modal-body").load('{{ url('admin/accounting/advance_for') }}/' + id,
                    function(res) {
