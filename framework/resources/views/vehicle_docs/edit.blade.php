                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('vehicle_id', $vehicles, $doc->vehicle_id, [
                                    'class' => 'form-control',
                                    'id' => 'vehicle_id',
                                    'required',
                                ]) !!}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('date', date('d-m-Y', strtotime($doc->date)), [
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('payment_date', $doc->payment_date ? date('d-m-Y', strtotime($doc->payment_date)) : null, [
                                'class' => 'form-control date',
                                'id' => 'payment_date',
                                'autocomplete' => 'off',
                            ]) !!}
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::select('vendor', $vendors, $doc->vendor_id, [
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::select('bank', $bankAccount, $doc->transaction->bank_id, [
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::select('method', $method, $doc->method, [
            ...
            $("body").on("focus", ".date", function() {
                ...
                $(this).datepicker({
                    ...
                    onSelect: function(date) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "{{ route('vehicle-docs.getNextEdit') }}",
                            data: dataSet,
