                                            ...
                                            <tr>
                                                ...
                                                @if ($expirationDateSet)
                                                    @if ($durationUnitSet)
                                                        @if ($lastDay)
                                                            <td>
                                                                {!! Form::text("date[$v->id][$doc->id]", null, [
                                                            ...
                                                            <td>
                                                                {!! Form::text("payment_date[$v->id][$doc->id]", null, [
                                                            ...
                                                            <td>
                                                                {!! Form::text("amount[$v->id][$doc->id]", null, [
                                                                    'class' => 'form-control amount',
                                                                    'required',
                                                                    'onkeypress' => 'return isNumber(event,this)',
                                                                    'placeholder' => 'Enter Renewal Amount',
                                                                ]) !!}
                                                                {!! Form::select("vendor[$v->id][$doc->id]", $vendors, null, [
                                                            ...
                                                            <td>
                                                                {!! Form::select("bank[$v->id][$doc->id]", $bankAccount, null, [
                                                                    'class' => 'form-control bank',
                                                                    'required',
                                                                    'placeholder' => 'Select Bank',
                                                                    'style' => 'margin-top:10px;',
                                                                ]) !!}
                                                                {!! Form::select("method[$v->id][$doc->id]", $method, null, [
                                                            ...
                                                            <td>
                                                                {!! Form::text("ddno[$v->id][$doc->id]", null, [
                                                                    'class' => 'form-control ddno',
                                                                    'required',
                                                                    'style' => 'margin-top: 9px;',
                                                                    'placeholder' => 'Reference No.',
                                                                ]) !!}
                                                                {!! Form::textarea("remarks[$v->id][$doc->id]", null, [
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type="hidden" name="hiddenInput"
                                                                    class="singleVehicleId" value="{{ $v->id }}">
                                                            </td>
                                                        @else
                                                            <td colspan="6" align="center">
                                                                @if (!empty($expirationDate))
                                                                    <p>Document expires on: {{ $expirationDate }}</p>
                                                                    <p>Early renewal available from:
                                                                        {{ $earlyRenewalDate }}</p>
                                                                    @if ($daysLeft > 0)
                                                                        @lang('fleet.after') {{ $daysLeft }}
                                                                        @lang('fleet.days')
                                                                    @endif
                                                                @endif
                                                            </td>
                                                    ...
                                                    @else
                                                        <td colspan="6" align="center">
                                                            <label for="">{{ $doc->label }} duration and unit
                                                                is not set</label>
                                                            <a href="../vehicles/{{ $v->id }}/edit?tab=insurance"
                                                                target="_blank">click here</a> to set
                                                        </td>
                                                    @endif
                                                @else
                                                    <td colspan="6" align="center">
                                                        <label for="">{{ $doc->label }} expiration date is
                                                            not set</label>
                                                        <a href="../vehicles/{{ $v->id }}/edit?tab=insurance"
                                                            target="_blank">click here</a> to set
                                                    </td>
