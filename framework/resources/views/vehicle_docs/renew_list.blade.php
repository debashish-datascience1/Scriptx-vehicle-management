                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @if($expirationDateSet)
                                                ...
                                                @else
                                                    <td colspan="5" align="center">
                                                        @if(!empty($expirationDate))
                                                            ...
                                                            <p>Early renewal available from: {{ $earlyRenewalDate }}</p>
                                                            @if($daysLeft > 0)
                                            ...
                                            @else
                                                <td colspan="5" align="center">
                                                    <label for="">{{$doc->label}} duration and unit is not set</label> 
                                                    <a href="../vehicles/{{$v->id}}/edit?tab=insurance" target="_blank">click here</a> to set
                                                </td>
                                            @endif
                                        @else
                                            <td colspan="5" align="center">
                                                <label for="">{{$doc->label}} expiration date is not set</label> 
                                                <a href="../vehicles/{{$v->id}}/edit?tab=insurance" target="_blank">click here</a> to set
                                            </td>
                                        @endif
                                    </tr>
