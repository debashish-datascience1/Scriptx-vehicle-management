...
<li class="breadcrumb-item active">@lang('fleet.collect_loan')</li>
@endsection
  ...
  <div class="col-md-12">
    <div class="card card-warning">
      <div class="card-header">
        <h3 class="card-title">@lang('fleet.collect_loan')</h3>
      </div>
      ...
      <div class="card-body">
        ...
        {!! Form::open(['route' => ['loan-give.process-return', $loanTake->id], 'method' => 'POST']) !!}
        <div class="row">
          <div class="col-md-6">
