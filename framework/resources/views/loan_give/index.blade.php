  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        ...
        &nbsp;
        <a href="{{ route('loan-give.create')}}" class="btn btn-success">@lang('fleet.loan_give')</a>
        </h3>
      </div>
              ...
              <td>
                <div class="btn-group">
                  ...
                  <div class="dropdown-menu custom" role="menu">
                    <a class="dropdown-item" href="{{ route('loan-give.show', $loanTake->id) }}">
                      <span aria-hidden="true" class="fa fa-eye" style="color: #398439;"></span> @lang('fleet.details')
                    </a>
                    <a class="dropdown-item" href="{{ route('loan-give.edit', $loanTake->id) }}">
                      <span aria-hidden="true" class="fa fa-edit" style="color: #f0ad4e;"></span> @lang('fleet.edit')
                    </a>
                    <a class="dropdown-item" href="{{ route('loan-give.return', $loanTake->id) }}">
                      <span aria-hidden="true" class="fa fa-undo" style="color: #3c8dbc;"></span> @lang('fleet.collect')
                    </a>
                    {!! Form::open(['url' => 'admin/loan-give/'.$loanTake->id, 'method' => 'DELETE', 'class' => 'form-horizontal', 'id' => 'form_'.$loanTake->id]) !!}
