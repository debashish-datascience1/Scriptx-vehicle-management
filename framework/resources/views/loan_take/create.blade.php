...
<li class="breadcrumb-item active">@lang('fleet.create_loan_take')</li>
@endsection
  ...
  <div class="col-md-12">
    <div class="card card-success">
      <div class="card-header">
        <h3 class="card-title">@lang('fleet.create_loan_take')</h3>
      </div>
      ...
      <div class="card-body">
        ...
        {!! Form::open(['route' => 'loan-take.store','method'=>'post']) !!}
        <div class="row">
          <div class="col-md-6">
