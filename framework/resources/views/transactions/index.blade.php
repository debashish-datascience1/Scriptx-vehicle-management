        ...
        <table class="table" id="data_table" style="padding-bottom: 15px">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a class="badge badge-viwevent vevent" data-id="{{$row->id}}" data-toggle="modal" data-target="#viewModal" title="{{$row->transaction_id}}">
                {{$row->transaction_id}}
                </a><br>
                {{-- <strong>{{!empty($row->rem->date) ? Helper::getCanonicalDateTime($row->rem->date,'default') : Helper::getCanonicalDateTime($row->rem->created_at,'default')}}</strong> --}}
              ...
              <td>
                ...
                @elseif($row->param_id==31)
                  ...
                  @if (!empty($row->from_transaction))
                    <br>
                      <strong>Ref. ID : </strong>
                      <a class="badge badge-viwevent where_from" data-id="{{$row->from_transaction}}" data-toggle="modal" data-target="#viewModal" title="{{$row->transaction_id}}">
                        {{$row->from_transa->transaction_id}}
                      </a>
                  @endif
