...
<div class="row">
  <div class="col-md-12">
    <div class="card card-info">
      ...
      <div class="card-body">
        {!! Form::open(['route' => 'reports.transaction','method'=>'post','class'=>'form-inline']) !!}
        <div class="row newrow">
					<div class="col-md-3">
						<div class="form-group">
            {!! Form::label('from', 'Head', ['class' => 'form-label']) !!}
            {!!Form::select('from',$from,$request['from'] ?? null,['class'=>'form-control fullsize','placeholder'=>'Select Head'])!!}
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
              {!! Form::label('payment', 'Payment', ['class' => 'form-label']) !!}
              {!!Form::select('payment_type',$payment_type,$request['payment_type'] ?? null,['class'=>'form-control fullsize','placeholder'=>'Type'])!!}
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
          ...
          <div class="col-md-3">
            ...
            <button type="submit" formaction="{{url('admin/print-transaction-report')}}" formtarget="_blank" class="btn btn-danger"><i class="fa fa-print"></i> @lang('fleet.print')</button>
          </div>
        </div>
          {!! Form::close() !!}
        </div>
  ...
  <div class="col-md-12">
    <div class="card card-info">
      ...
      <div class="card-body table-responsive">
        ...
        <br>
        <table class="table">
          <tr> <th style="float:right">Grand Total : {{Hyvikk::get('currency')}} {{bcdiv($sumoftotal,1,2)}}</th>
          </tr>
      </table>
      </div>
    </div>
