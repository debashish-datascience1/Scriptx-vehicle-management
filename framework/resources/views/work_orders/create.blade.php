  ...
  <div class="col-md-12">
    <div class="card card-success">
      ...
      <div class="card-body">
          ...
          <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-6">
                ...
                {!! Form::select('category_id',$orderHeads,null,['class' => 'form-control','required','placeholder'=>'Select Order Head']) !!}
                </div>
              </div>
              <div class="col-6">
                <div class="form-group">
        ...
        <div class="row" style="margin-bottom: 25px;">
          <div class="col-md-2"> 
            <div class="form-group"> 
              ...
              {!! Form::select('is_addParts',[2=>'No',1=>'Yes'],null,['class'=>'form-control','id'=>'is_addParts']) !!}
            </div>
          </div>
        </div>
        <div class="parts-div">
        ...
        <div class="row">
          <div class="col-md-12">
            {!! Form::submit(__('fleet.add_order'), ['class' => 'btn btn-success','id'=>'addwork']) !!}
          </div>
        </div>
      </div>
    </div>
