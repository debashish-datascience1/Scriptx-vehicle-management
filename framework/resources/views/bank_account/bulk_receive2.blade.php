            ...
            @if(count($transactions)>0)
                ...
                <td class="remnants">
                  ...
                  <div class='input-group date'>
                    ...
                    {!!Form::text("price[$row->id]",null,['class'=>'form-control price','readonly','placeholder'=>'Price...','step'=>'any','onkeypress'=>'return isNumber(event,this)'])!!}
                  </div>
          ...
          <tfoot>
            ...
            <tr>
              ...
              <th colspan="2">
                ...
                {!!Form::text('date',$now,['class'=>'form-control','readonly'])!!}
              </th>
            </tr>
            <tr>
                <th colspan="4"></th>
