        ...
        <table class="table table-bordered table-striped table-hover"  id="">
          ...
          <tbody>
            @if(count($transactions)>0)
                ...
                <td>
                  {{date("H:i:s",strtotime($row->date))!="00:00:00" ? Helper::getCanonicalDateTime($row->date,'default') : Helper::getCanonicalDate($row->date,'default')}}
                </td>
                ...
                <td class="remnants">
                  ...
                  <div class='input-group date'>
                    ...
                    {!!Form::text("price[$row->id]",null,['class'=>'form-control price','disabled','placeholder'=>'Price...','step'=>'any','onkeypress'=>'return isNumber(event,this)'])!!}<br>
                  </div>
                  {{-- <div class="method">
