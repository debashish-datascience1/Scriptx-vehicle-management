    ...
    <div class="col-md-12">
        <div class="card card-success">
            ...
            <div class="card-body">
                ...
                {!! Form::open(['route' => 'fastag.store', 'method' => 'post', 'id' => 'fastagForm']) !!}
                {!! Form::hidden('grand_total', '0.00', ['id' => 'grand_total_input']) !!}
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('toll_gate_name[]', null, ['class' => 'form-control', 'required']) !!}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    {!! Form::label('amount[]', 'Amount', ['class' => 'form-label required']) !!}
                                    {!! Form::number('amount[]', null, ['class' => 'form-control amount-input', 'required', 'step' => '0.01']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
