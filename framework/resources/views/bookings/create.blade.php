  ...
  <div class="col-md-12">
    <div class="card card-success">
      ...
      <div class="card-body">
        ...
        {!! Form::open(['route' => 'bookings.store','method'=>'post','id'=>'bookingForm','files'=>true]) !!}
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class='input-group mb-3 date'>
                ...
                {!! Form::text('pickup',date("Y-m-d H:i:s"),['class'=>'form-control','required','onchange'=>'return checkTop()']) !!}
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class='input-group date'>
                ...
                {!! Form::text('dropoff',date("Y-m-d H:i:s"),['class'=>'form-control','required','readonly']) !!}
              </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <select id="vehicle_id" name="vehicle_id" class="form-control" required onchange='return checkTop()'>
                ...
                <option value="{{$vehicle->id}}" data-driver="{{$vehicle->driver_id}}" data-mileage="{{$vehicle->average}}" data-tmileage="{{Helper::digitsToTime($vehicle->time_average)}}">{{$vehicle->make}} - {{$vehicle->model}} - {{$vehicle->license_plate}} 
                </option>
                @endforeach
              </select>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              {!! Form::text('material','',['class'=>'form-control','id'=>'material','required','onchange'=>'return checkTop()']) !!}
            </div>
          </div>
        </div>
        {{-- @if(Auth::user()->user_type == "C")
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              {!! Form::select('mileage_type',$mileagetypes,null,['class'=>'form-control','min'=>1,'required','onchange'=>'return checkTop()']) !!}
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('pickup_addr',__('fleet.pickup_addr'), ['class' => 'form-label']) !!}
              {!! Form::text('pickup_addr',null,['class'=>'form-control','required','onchange'=>'return checkTop()']) !!}
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              {!! Form::text('dest_addr',null,['class'=>'form-control','required']) !!}
            </div>
          </div>
        </div>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <input type="hidden" name="_blob" id="_blob" value="">
                      ...
                      <span class="pet-required">{{number_format(316/21,'2')}}</span> ltr
                    </div>
                    <div class="col-md-4 form-group">
                      <label class="form-label">Fuel Rate :</label>
                        {!! Form::number('petrol_perltr',null,['class'=>'form-control petrol_perltr','min'=>1,'style'=>'width:25%;display:inline','step'=>'0.01']) !!}
                    </div>
                    <div class="col-md-4 form-group">
                  ...
                  <div class="row">
                    <div class="col-md-4 form-group">
                      ...
                      {!! Form::select('load_set',$loadsetting,null,['placeholder'=>'Select Load','class'=>'form-control load_set','style'=>'width:45%;display:inline']) !!}
                    </div>
                    <div class="col-md-4 form-group">
                      <label class="form-label">Load :</label>
                      {!! Form::number('load_price',null,['class'=>'form-control load_price','min'=>1,'style'=>'width:23%;display:inline','min'=>1,'required','placeholder'=>'Price']) !!}
                      x
                        {!! Form::number('load_qty',null,['class'=>'form-control load_qty','min'=>1,'style'=>'width:27%;display:inline','min'=>1,'required','placeholder'=>'Quantity']) !!}
                      ...
                      <div class="card card-default">
                        ...
                        <table class="table table-bordered">
                          <tr>
                            ...
                            <td>
                            {!! Form::text('party_name',null,['class'=>'form-control','style'=>'display:inline','required','placeholder'=>'Party Name...']) !!}
                            </td>
                            <td>
                              <label class="form-label">Narration :</label>
                            </td>
                            <td>
                            {!! Form::text('narration',null,['class'=>'form-control','style'=>'display:inline','required','placeholder'=>'Narration..']) !!}
                            </td>
                          </tr>
                          <tr>
                            <td>
                            ...
                            <td>
                            {!! Form::number('total_pay',null,['class'=>'form-control total_pay','min'=>1,'style'=>'display:inline','min'=>1,'required','placeholder'=>'Total Payment..','readonly']) !!}
                            </td>
                            <td>
                              <label class="form-label">Advance to Driver :</label>
                            </td>
                            <td>
                            {!! Form::number('advance_pay',null,['class'=>'form-control advance_pay','min'=>1,'style'=>'display:inline','min'=>1,'required','placeholder'=>'Price']) !!}
                          ...
                          <tr>
                            ...
                            <td>
                            {!! Form::select('payment_type',$payment_type,null,['class'=>'form-control payment_type','id'=>'payment_type','placeholder'=>'Select Payment Type']) !!}
                            </td>
                            <td>
                              <label class="form-label">Payment Amount :</label>
                            </td>
                            <td>
                            {!! Form::text('payment_amount',null,['class'=>'form-control','id'=>'payment_amount','style'=>'display:inline','onkeypress'=>'return isNumber(event)','placeholder'=>'Payment from Customer']) !!}
                            </td>
                          </tr>
                          <tr>
                              <td>
                            ...
                            <td>
                            {!! Form::textarea('remarks',null,['class'=>'form-control','placeholder'=>'Remarks about the payment..','style'=>'resize:none;height:100px;']) !!}
                            </td>
                          </tr>
                          <tr>
        ...
        <div class="form-group">
          ...
          <div class="input-group mb-3">
            <div class="input-group-prepend">
              ...
              {!! Form::text('company_gst', null,['class' => 'form-control','required']) !!}
          </div>
        </div>
          ...
          $.ajax({
            ...
            success: function(response){
              ...
              if(response.status==true){
                ...
                $("#driver_id").select2({placeholder: "@lang('fleet.selectDriver')",data:response.resp.data_driver});
                $("#vehicle_id").select2({placeholder: "@lang('fleet.selectVehicle')",data:response.resp.data});
  ...
  function initialize() {
      ...
      function callback(response, status) {
          if (status == 'OK') {
              ...
              var data = {_token:"{{csrf_token()}}",currTime : $("#pickup").val(),duration:respDuration.text};
              ...
              if(mileage_type==34){
                  var kmarray = {_token:"{{csrf_token()}}",vehicle : $("#vehicle_id").val(),duration:respDuration.text};
                var timeper = $.post("{{route('bookings.timeperltr')}}",kmarray)
