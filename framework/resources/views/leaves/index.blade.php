...
@endsection
@section("breadcrumb")
<li class="breadcrumb-item active">@lang('fleet.leave')</li>
@endsection
@section('content')
<div class="row">
  <div class="col-md-12">
    ...
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">@lang('fleet.leave') &nbsp;
          <a href="{{ route("leave.create") }}" class="btn btn-success"> Add Leave </a>
        </h3>
      </div>
