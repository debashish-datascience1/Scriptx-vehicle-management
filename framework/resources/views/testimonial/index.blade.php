  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        ...
        <a href="{{ route('testimonials.create')}}" class="btn btn-success">@lang('fleet.addNew')</a></h3>
      </div>
            ...
            <tr>
              ...
              <div class="btn-group">
                ...
                <div class="dropdown-menu custom" role="menu">
                  <a class="dropdown-item" href="{{url("admin/testimonials/".$row->id."/edit") }}"> <span aria-hidden="true" class="fa fa-edit" style="color: #f0ad4e;"></span> @lang('fleet.edit')</a>
