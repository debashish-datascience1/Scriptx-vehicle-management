        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    {!! Form::label('vehicle_company',"Vehicle's Company", ['class' => 'form-label']) !!}
                    <pre><code>make:ASHOK LEYLAND</code></pre>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    {!! Form::label('vehicle_model',"Vehicle's Model", ['class' => 'form-label']) !!}
            ...
            <div class="col-md-6">
                <div class="form-group">
                    {!! Form::label('fuel_date',"Fuel Date", ['class' => 'form-label']) !!}
