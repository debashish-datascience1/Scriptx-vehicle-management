...
<li class="breadcrumb-item active">@lang('fleet.fuelTypeReport')</li>
@endsection
@section('extra_css')
  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">@lang('fleet.fuelTypeReport')
        </h3>
      </div>

      <div class="card-body">
        {!! Form::open(['route' => 'reports.fuel-type','method'=>'post','class'=>'form-inline']) !!}
        <div class="row newrow">
					<div class="col-md-3">
            <div class="form-group">
              {!! Form::label('vendor', __('fleet.vendor'), ['class' => 'form-label']) !!}
              {!!Form::select('vendor',$vendors,$request['vendor'] ?? null,['class'=>'form-control fullsize','placeholder'=>'Select Fuel Vendor'])!!}
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
        ...
        <div class="row newrow">
            ...
            <button type="submit" formaction="{{url('admin/print-fuel-vendor-report')}}" formtarget="_blank" class="btn btn-danger"><i class="fa fa-print"></i> @lang('fleet.print')</button>
          </div>
          {!! Form::close() !!}
        </div>
      </div>
        ...
        <table class="table table-bordered table-striped table-hover"  id="myTable">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{$row->qty}}</td>
              <td>{{Hyvikk::get('currency')}} {{Helper::properDecimals($row->total_cost)}}</td>
              <td><a class="DetailsChk" data-id="{{$row->vendor_name}}"  data-fuel="{{$row->fuel_type}}" data-toggle="modal" data-target="#FuelDetailsModal"> <span aria-hidden="true" class="fa fa-eye" style="color: green"></span> Details</a></td>
            </tr>
            @endforeach
          </tbody>
          <tfoot>
...
$(document).ready(function() {
    ...
    $(".DetailsChk").on("click",function(){
      ...
      $("#FuelDetailsModal .modal-body").load('{{url("admin/reports/view_fuel_details")}}/'+arr,function(res){
