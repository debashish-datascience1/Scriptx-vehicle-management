    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <small>{{Helper::getCanonicalDate($date['from_date'],'default')}}</small> -
          <small>{{Helper::getCanonicalDate($date['to_date'],'default')}}</small>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
            ...
            <tbody>
                @foreach($fuelv as $k=>$row)
                    <tr>
                        ...
                        <td>{{Helper::properDecimals($row->qty)}}</td>
                ...
                <tr>
                    <th colspan="2"></th>
                    <th>Grand Total</th>
                    <th>{{Helper::properDecimals($grandtotal_qty)}}</th>
                    <th>{{Hyvikk::get('currency')}} {{Helper::properDecimals($grandtotal_cost)}}</th>
                </tr>
            </tbody>
            <tfoot>
          </table>
