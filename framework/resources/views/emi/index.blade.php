  ...
  <div class="col-md-12">
    ...
    <div class="card card-info">
      <div class="card-header">
        ...
        Vehicle EMI
        &nbsp;
        <a href="{{ route('vehicle-emi.create')}}" class="btn btn-success">Pay EMI</a>
        </h3>
      </div>
      ...
      <div class="card-body table-responsive">
        <table class="table" id="myTable">
          ...
          <tbody>
          @foreach($emi as $k=>$row)
            <tr>
              <td>{{$k+1}}</td>
              <td>{{Helper::getTransaction($row->id,50)->transaction_id}}</td>
              ...
              <td>{{!empty($row->bank) ? $row->bank->bank : '-'}}</td>
              ...
              <td>
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu custom" role="menu">
                      ...
                      {{-- @if(Helper::isEligible($row->id,50)) --}}
                      <a class="dropdown-item" href="{{url("admin/vehicles/vehicle-emi/".$row->id."/edit") }}"><span aria-hidden="true" class="fa fa-edit" style="color: #f0ad4e;"></span> @lang('fleet.edit')</a>
                    ...
                    {!! Form::open(['url' => 'admin/vehicles/vehicle-emi/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]) !!}
                    {!! Form::hidden("id",$row->id) !!}
                    {!! Form::close() !!}
              </td>
            </tr>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        {!! Form::open(['url'=>'admin/emi','method'=>'POST','id'=>'form_delete']) !!}
...
<script type="text/javascript">
 $(".vevent").click(function(){
    var id = $(this).data("id");
    // console.log(id)
      $("#viewModal .modal-body").load('{{url("admin/vehicles/vehicle-emi/view_event")}}/'+id,function(res){
        // console.log(res)
