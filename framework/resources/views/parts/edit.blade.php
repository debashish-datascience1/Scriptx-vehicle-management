...
<li class="breadcrumb-item active">Edit @lang('fleet.parts')</li>
@endsection
@section('content')
<div class="row">
  <div class="col-md-12">
    <div class="card card-success">
      <div class="card-header">
        <h3 class="card-title">Edit @lang('fleet.parts')</h3>
      </div>
      ...
      <div class="card-body">
          ...
          {!! Form::model($data,['route' => ['parts.update',$data->id],'method'=>'PATCH','files'=>true]) !!}
