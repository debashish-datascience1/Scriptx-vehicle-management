    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <small>{{Helper::getCanonicalDate($date['from_date'],'default')}}</small> to
            ...
            <tbody>
                @foreach($advances as $k=>$row)
                    <tr>
                        ...
                        <td>{{$row->assigned_vehicle->vehicle->license_plate}}</td>
                ...
                <tr>
                  <th colspan="4"></th>
                  <th>Grand Total</th>
                  <th>{{Hyvikk::get('currency')}} {{bcdiv($advances->sum('amount'),1,2)}}</th>
                </tr>
            <tfoot>
          </table>
        </div>
