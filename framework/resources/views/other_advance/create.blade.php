...
<li class="breadcrumb-item active">Add @lang('fleet.other_advance')</li>
@endsection
  ...
  <div class="col-md-12">
    <div class="card card-success">
      <div class="card-header with-border">
        <h3 class="card-title">Add @lang('fleet.other_advance')</h3>
      </div>
      ...
      <div class="card-body">
        ...
        {!! Form::open(['route' => 'other-advance.store','files'=>true,'method'=>'post']) !!}
        <div class="row">
          <div class="col-md-4">
