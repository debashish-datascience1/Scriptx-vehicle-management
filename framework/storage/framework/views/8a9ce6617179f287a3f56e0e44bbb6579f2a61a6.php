          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <select id="vehicle_id" name="vehicle_id" class="form-control" required onchange='return checkTop()'>
                ...
                <option value="<?php echo e($vehicle->id); ?>" data-driver="<?php echo e($vehicle->driver_id); ?>" data-mileage="<?php echo e($vehicle->average); ?>"><?php echo e($vehicle->make); ?> - <?php echo e($vehicle->model); ?> - <?php echo e($vehicle->license_plate); ?> 
                </option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <?php echo Form::number('initial_km',null,['class'=>'form-control','min'=>1,'required','onchange'=>'return checkTop()']); ?>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $(".advance_pay").keyup(function(){
      var purse = $('#cash').val();
      var enter = $(this).val();
      var ifsd = enter>purse ? true : false;
      console.log(purse)
      console.log(enter)
      console.log(ifsd)
      if(enter>purse)
...
<?php if(Hyvikk::api('google_api') == "1"): ?>
  ...
  function initialize() {
    ...
    function checkFields(){
      var blankTest = /\S/;
      var label = ['customer_id','pickup','dropoff','vehicle_id','driver_id','material','initial_km','pickup_addr','dest_addr','petrol_perltr','load_price','load_qty','load_set'];
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/VehicleMgmt/framework/resources/views/bookings/create.blade.php ENDPATH**/ ?>