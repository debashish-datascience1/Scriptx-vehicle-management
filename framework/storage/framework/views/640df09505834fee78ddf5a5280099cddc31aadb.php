    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          <h3><?php echo app('translator')->getFromJson('fleet.vendorReport'); ?></h3>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
...
</html><?php /**PATH /var/www/html/VehicleMgmt/framework/resources/views/reports/print_vendor.blade.php ENDPATH**/ ?>