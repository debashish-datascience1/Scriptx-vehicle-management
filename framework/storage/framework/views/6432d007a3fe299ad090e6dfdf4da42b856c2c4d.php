...
<?php $__env->startSection('content'); ?>
    <div class="container">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6 d-flex align-items-end">
                        ...
                        <button type="submit" formaction="<?php echo e(route('reports.cash-book.print')); ?>"
                            class="btn btn-print text-white" formtarget="_blank">
        ...
        <?php if(isset($bookings)): ?>
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title m-0">Cash Book Summary for
                        <?php echo e(date(Hyvikk::get('date_format') ? Hyvikk::get('date_format') : 'd-m-Y', strtotime($date))); ?></h3>
                </div>
                <div class="card-body">
                    <div class="row">
                    ...
                    <div class="row mt-4">
                        <div class="col-12 text-center">
                            <h4 class="cash-balance">Cash Balance: <?php echo e(Hyvikk::get('currency')); ?>

                                <?php echo e(number_format($cash_balance, 2)); ?></h4>
                        </div>
                    </div>
                </div>
            </div>
