    ...
    <div class="card card-info">
      ...
      <div class="card-body table-responsive">
        <table class="table" id="data_table">
          ...
          <tbody>
          <?php $__currentLoopData = $payrolls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              <td>
              ...
              <td><?php echo e(number_format($row->salary,2)); ?></td>
              <td>
                <?php $month = $row->for_month<10 ? "0".$row->for_month:$row->for_month;  ?>
                <?php echo e(date("F-Y",strtotime($row->for_year."-".$month."-01"))); ?>

              </td>
              <td><?php echo e($row->working_days); ?></td>
              <td><?php echo e(number_format($row->advance_salary,2)); ?></td>
              <td><?php echo e(!empty($row->payable_salary) ? number_format($row->payable_salary,2) : '0.00'); ?></td>
              <td>
              <div class="btn-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/VehicleMgmt/framework/resources/views/payroll/manage.blade.php ENDPATH**/ ?>