            ...
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  ...
                  <?php echo Form::text('company_gst', $data->gstin,['class' => 'form-control','required']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/VehicleMgmt/framework/resources/views/customers/edit.blade.php ENDPATH**/ ?>