    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          ...
          <?php echo Form::text('title[]', null,['class' => 'form-control title','required']); ?>
      ...
      <div class="col-md-6">
          <div class="form-group">
            ...
            <?php echo Form::select("category_id[]",$categories,null,['class'=>'form-control category_id','required','placeholder'=>'Select Category']); ?>
...
</div><?php /**PATH /home1/scripyat/public_html/scriptx.in/VehicleMgmt/framework/resources/views/parts/parts_form.blade.php ENDPATH**/ ?>