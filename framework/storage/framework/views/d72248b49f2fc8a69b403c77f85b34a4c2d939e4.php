...
<div class="row">
	<div class="col-md-12">
		<div class="card card-info">
			...
			<div class="card-body">
				<?php echo Form::open(['route' => 'reports.other-advance','method'=>'post','class'=>'form-block']); ?>
				...
				<div class="row newrow">
					...
					<div class="col-md-2">
						<div class="form-group">
							...
							<?php echo Form::select('status',$status,$request['status'] ?? null,['class'=>'form-control fullsize','id'=>'status','placeholder'=>'Select Status']); ?>
				...
				<div class="row newrow">
					<div class="col-md-12">
						...
						<button type="submit" formaction="<?php echo e(url('admin/print-other-advance-report')); ?>" formtarget="_blank" class="btn btn-danger"><i class="fa fa-print"></i> <?php echo app('translator')->getFromJson('fleet.print'); ?></button>
					</div>
				</div>
				<?php echo Form::close(); ?>
		...
		<div class="card card-info">
			...
			<div class="card-body table-responsive">
				<table class="table table-bordered table-striped table-hover"  id="myTable">
					...
					<tbody>
					<?php $__currentLoopData = $other_adv; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$oth): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
                            <td><?php echo e($k+1); ?></td>
							<td><?php echo e($oth->driver->name); ?></td>
                            <td nowrap><?php echo e(Helper::getCanonicalDate($oth->date,'default')); ?></td>
                            <td><?php echo e(Helper::properdecimals($oth->amount)); ?></td>
							<td>
								<?php echo e($oth->bank_details->bank); ?><br>
								<strong><?php echo e($oth->bank_details->account_no); ?></strong>
							</td>
							<td><?php echo e($oth->method_param->label); ?><br><?php echo e($oth->ref_no); ?></td>
							<td>
								<?php if($oth->is_adjusted==1): ?>
									<span class="badge badge-success">Completed</span>
								<?php elseif($oth->is_adjusted==2): ?>
									<span class="badge badge-primary">In Progress</span>
								<?php elseif($oth->is_adjusted==null): ?>
				...
				<table class="table">
					<tr>
                        <th style="float:right">Total Advance: <?php echo e(Hyvikk::get('currency')); ?><?php echo e(Helper::properDecimals($other_adv->sum('amount'))); ?></th>
					</tr>
				</table>
			</div>
		</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/scripyat/public_html/scriptx.in/VehicleMgmt/framework/resources/views/other_advance/report.blade.php ENDPATH**/ ?>