        ...
        <div class="tab-pane active" id="info-tab">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td><?php echo e(Helper::getCanonicalDate($booking->pickup)); ?> <?php echo e(date("g:i:s A",strtotime($booking->pickup))); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><?php echo e(Helper::getCanonicalDate($booking->dropoff)); ?> <?php echo e(date("g:i:s A",strtotime($booking->dropoff))); ?></td>
                </tr>
                <tr>
                    <th>Party Name</th>
...
<?php /**PATH /var/www/html/VehicleMgmt/framework/resources/views/bookings/view_event.blade.php ENDPATH**/ ?>