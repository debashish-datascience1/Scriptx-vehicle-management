...
<li class="breadcrumb-item active">Fuel Transport Report</li>
<?php $__env->stopSection(); ?>
    ...
    <div class="col-md-12">
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Transporter Report</h3>
            </div>

            <div class="card-body">
                <?php echo Form::open(['route' => 'reports.fuel-transport_post','method'=>'post','class'=>'form-block']); ?>

                <div class="row newrow">
                    <div class="col-md-3">
                        <div class="form-group">
                            <?php echo Form::label('transport', 'Select Transporter', ['class' => 'form-label']); ?>

                            <?php echo Form::select('transport_id',$transports,$request['transport_id'] ?? null,['class'=>'form-control transports fullsize','id'=>'transport_id','placeholder'=>'ALL']); ?>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php echo Form::select('fuel_type',$fuel_types,$request['fuel_type'] ?? null,['class'=>'form-control transports fullsize','id'=>'fuel_type','placeholder'=>'ALL']); ?>
                ...
                <div class="row newrow">
                    <div class="col-md-12">
                        ...
                        <button type="submit" formaction="<?php echo e(url('admin/print-fuel-transport-report')); ?>" formtarget="_blank" class="btn btn-danger"><i class="fa fa-print"></i> <?php echo app('translator')->getFromJson('fleet.print'); ?></button>
                    </div>
                </div>
                <?php echo Form::close(); ?>
...
<div class="row">
    <div class="col-md-12">
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Fuel Transport Report</h3>
            </div>
...
<?php $__currentLoopData = $fuel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
        ...
        <td><strong><?php echo e($f->group_transport->group_name ?? 'N/A'); ?></strong></td>
        <td>
            <?php if($f->vehicle_data): ?>
                <?php echo e($f->vehicle_data->license_plate); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\VehicleMgmt\framework\resources\views/reports/fuel_transport.blade.php ENDPATH**/ ?>