    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <?php if(!empty($request['date1']) && !empty($request['date2'])): ?>
            <h4>
              <strong>From:</strong> <?php echo e(Helper::getCanonicalDate($request['date1'],'default')); ?> 
              <strong>To:</strong> <?php echo e(Helper::getCanonicalDate($request['date2'],'default')); ?>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <table class="table table-bordered">
                ...
                <tr>
                    <td><?php echo e(preg_match('/^[0-9]+(\.[0-9]+)?$/', $booking_distance) === 1 ? bcdiv($booking_distance,1,2) : 0); ?> km</td>
...
</html><?php /**PATH C:\xampp7.4\htdocs\VehicleMgmt\framework\resources\views/reports/print_bookings.blade.php ENDPATH**/ ?>