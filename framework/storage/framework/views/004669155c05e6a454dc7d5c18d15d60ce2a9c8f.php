        ...
        <table class="table" id="data_table" style="padding-bottom: 15px">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo e(empty($row->getMeta('start_date')) ? Helper::getCanonicalDate($row->created_at,'default') : Helper::getCanonicalDate($row->getMeta('start_date'),'default')); ?></td>
              <td>
              <div class="btn-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/scripyat/public_html/scriptx.in/VehicleMgmt/framework/resources/views/drivers/index.blade.php ENDPATH**/ ?>