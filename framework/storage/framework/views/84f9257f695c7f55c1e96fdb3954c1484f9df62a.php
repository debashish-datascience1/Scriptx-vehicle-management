...
<li class="breadcrumb-item active"><?php echo app('translator')->getFromJson('fleet.fuel_purchase'); ?></li>
  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">
        <?php echo app('translator')->getFromJson('fleet.fuel_purchase'); ?>
        &nbsp;
        <a href="<?php echo e(route('fuel_purchase.create')); ?>" class="btn btn-success"><?php echo app('translator')->getFromJson('fleet.add_fuel_purchase'); ?></a>
      ...
      <div class="card-body table-responsive">
        <table class="table" id="data_table">
          ...
          <tbody>
          <?php $__currentLoopData = $fuel_purchases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              <td><?php echo e($purchase->date); ?></td>
              <td><?php echo e($purchase->vendor->name ?? 'N/A'); ?></td>
              <td><?php echo e(number_format($purchase->quantity, 2)); ?></td>
              ...
              <td>
                <div class="btn-group">
                  ...
                  <div class="dropdown-menu custom" role="menu">
                    <a class="dropdown-item" href="<?php echo e(route('fuel_purchase.edit', $purchase->id)); ?>">
                      <span aria-hidden="true" class="fa fa-edit" style="color: #f0ad4e;"></span> <?php echo app('translator')->getFromJson('fleet.edit'); ?>
                    </a>
                    <?php echo Form::open(['url' => 'admin/fuel_purchase/'.$purchase->id, 'method' => 'DELETE', 'class' => 'form-horizontal', 'id' => 'form_'.$purchase->id]); ?>

                    <a class="dropdown-item" data-id="<?php echo e($purchase->id); ?>" data-toggle="modal" data-target="#myModal">
        ...
        <?php echo e($fuel_purchases->links()); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.4\htdocs\VehicleMgmt\framework\resources\views/fuel_purchase/index.blade.php ENDPATH**/ ?>