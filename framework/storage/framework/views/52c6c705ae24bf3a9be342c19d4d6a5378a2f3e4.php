<?php $__env->startSection('exta_cs'); ?>
    <style>
...
<div class="row">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-xs-6">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text"><?php echo app('translator')->getFromJson('fleet.fuel'); ?></span>
                <span class="info-box-number"><small><?php echo e(Hyvikk::get("currency")); ?></small> <?php echo e($fuels); ?></span>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4  col-xs-6">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text"><?php echo app('translator')->getFromJson('fleet.work_orders'); ?></span>
                <span class="info-box-number"><?php echo e($work_orders); ?></span>
              </div>
            </div>
          </div>
          <?php endif; ?>
  ...
  <div class="col-md-12">
    <div class="card card-default">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->getFromJson("fleet.monthly_chart"); ?></h3>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
            <div class="card card-info">
              <div class="card-header"> <h5> <?php echo app('translator')->getFromJson('fleet.income'); ?> - <?php echo app('translator')->getFromJson('fleet.expense'); ?>  (<?php echo e(date("F")); ?>)</h5></div>
              <div class="card-body">
...
function random_color(i){
  ...
  return col_arr;
        ...
        var datewise_config = {
            ...
            data: {
                labels: [
                      <?php $__currentLoopData = $dates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        CanvasJS.formatDate( new Date("<?php echo e(date('Y-m-d H:i:s',strtotime($v))); ?>"), "DD/MM/YY"),
                ...
                datasets: [
                  {
                    ...
                    borderColor: '#5cb85c',
                    data: [<?php echo e($bookings_chartData); ?>],
                },
                  {
                    label: "Fuel",
                    backgroundColor: '#8bc34a',
                    borderColor: '#8bc34a',
                    data: [<?php echo e($fuel_chartData); ?>],
                    fill: false,
                }, 
                  {
                    ...
                    borderColor: '#c34a4a',
                    data: [<?php echo e($salary_advance_chartData); ?>],
                    fill: false,
                }, 
                  {
                    label: "Payroll",
                    ...
                    borderColor: '#5bc0de',
                    data: [<?php echo e($payroll_chartData); ?>],
                    fill: false,
                }, 
                  {
                    label: "Parts Invoice",
                    ...
                    borderColor: '#2f4f4f',
                    data: [<?php echo e($parts_invoice_chartData); ?>],
                    fill: false,
                }, 
                  {
                    label: "Work Orders",
                    ...
                    borderColor: '#800fd6',
                    data: [<?php echo e($work_order_chartData); ?>],
                    fill: false,
                }, 
              ]
            },
        ...
        window.onload = function() {
          var ctx = document.getElementById("yearly").getContext("2d");
            ...
            var chartData3 = {
            labels: [<?php $__currentLoopData = $fuel_expenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> "<?php echo e($exp->month); ?>-<?php echo e($exp->year); ?>", <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>],
            datasets: [{
                label: 'Fuel Amount',
                barPercentage: 0.5,
                // backgroundColor:'red',
                backgroundColor: random_color(<?php echo e(count($fuel_expenses)); ?>),
                barThickness: 6,
                maxBarThickness: 8,
                minBarLength: 2,
                data: [<?php $__currentLoopData = $fuel_expenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($exp->tot); ?>, <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>]
            }]
        };
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/scripyat/public_html/scriptx.in/VehicleMgmt/framework/resources/views/home.blade.php ENDPATH**/ ?>