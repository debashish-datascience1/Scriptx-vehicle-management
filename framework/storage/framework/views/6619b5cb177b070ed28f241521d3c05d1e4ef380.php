...
<li class="breadcrumb-item active"><?php echo app('translator')->getFromJson('fleet.collect_loan'); ?></li>
  ...
  <div class="col-md-12">
    <div class="card card-warning">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->getFromJson('fleet.collect_loan'); ?></h3>
      </div>
      ...
      <div class="card-body">
        ...
        <?php echo Form::open(['route' => ['loan-give.process-return', $loanTake->id], 'method' => 'POST']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.4\htdocs\VehicleMgmt\framework\resources\views/loan_give/return.blade.php ENDPATH**/ ?>