        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class="input-group">
                <div class="input-group-prepend">
                <?php echo Form::select('adphone_code',$phone_code,null,['class' => 'form-control code','required','style'=>'width:80px']); ?>

                </div>
                <?php echo Form::number('adphone', null,['class' => 'form-control','required']); ?>
        ...
        <div class="col-md-4">
          <div class="form-group">
            <?php echo Form::label('issue_date', __('fleet.issueDate'), ['class' => 'form-label']); ?>
              ...
              <div class="input-group date">
                ...
                <?php echo Form::text('issue_date', null,['class' => 'form-control','required','readonly']); ?>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class="input-group date">
                <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-calendar"></i></span></div>
                <?php echo Form::text('exp_date', null,['class' => 'form-control','required','readonly']); ?>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class="input-group date">
                <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-calendar"></i></span></div>
                <?php echo Form::text('start_date', null,['class' => 'form-control','required','readonly']); ?>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class="input-group date">
                ...
                <?php echo Form::text('salary', null,['class' => 'form-control','required','onkeypress'=>'return isNumber(event)']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/VehicleMgmt/framework/resources/views/drivers/create.blade.php ENDPATH**/ ?>