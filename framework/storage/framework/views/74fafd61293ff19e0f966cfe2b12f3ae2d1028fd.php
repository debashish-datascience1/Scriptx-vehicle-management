  ...
  <div class="col-md-12">
    <div class="card card-success">
      <div class="card-header with-border">
        <h3 class="card-title">Add <?php echo app('translator')->getFromJson('fleet.unit'); ?></h3>
      </div>
      ...
      <div class="card-body">
        ...
        <?php echo Form::open(['route' => 'unit.store','files'=>true,'method'=>'post']); ?>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <?php echo Form::text('name',null,['class' => 'form-control','id'=>'name','required','placeholder'=>'Enter Unit']); ?>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <?php echo Form::text('short_name',null,['class' => 'form-control','id'=>'short_name','required','placeholder'=>'Enter Unit Short Name']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/scripyat/public_html/scriptx.in/VehicleMgmt/framework/resources/views/unit/create.blade.php ENDPATH**/ ?>