  ...
  <div class="col-md-12">
    ...
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->getFromJson('fleet.transactions'); ?> &nbsp;
        </h3>
      </div>
        ...
        <table class="table" id="data_table" style="padding-bottom: 15px">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a class="badge badge-viwevent vevent" data-id="<?php echo e($row->id); ?>" data-toggle="modal" data-target="#viewModal" title="<?php echo e($row->transaction_id); ?>">
                <?php echo e($row->transaction_id); ?>

                </a><br>
                
                <strong><?php echo e(Helper::getCanonicalDateTime($row->rem->created_at,'default')); ?></strong>
              </td>
              ...
              <td>
                ...
                <?php elseif($row->param_id==31): ?>
                  ...
                  <?php if(!empty($row->from_transaction)): ?>
                    <br>
                      <strong>Ref. ID : </strong>
                      <a class="badge badge-viwevent where_from" data-id="<?php echo e($row->from_transaction); ?>" data-toggle="modal" data-target="#viewModal" title="<?php echo e($row->transaction_id); ?>">
                        <?php echo e($row->from_transa->transaction_id); ?>
              ...
              <td>
                ...
                <?php elseif($row->type==48): ?>
                    <span class="badge badge-primary"><?php echo e($row->pay_type->label); ?></span>
                <?php endif; ?>
              </td>
              
              <td><?php echo e(bcdiv($row->grandtotal,1,2)); ?></td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </tbody>
          <tfoot>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/scripyat/public_html/scriptx.in/VehicleMgmt/framework/resources/views/transactions/index.blade.php ENDPATH**/ ?>