    ...
    <div class="card card-info">
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <button type="submit" formaction="<?php echo e(url('admin/print-transaction-report')); ?>" class="btn btn-danger"><i class="fa fa-print"></i> <?php echo app('translator')->getFromJson('fleet.print'); ?></button>
          <?php echo Form::close(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/VehicleMgmt/framework/resources/views/transactions/reportDebitCredit.blade.php ENDPATH**/ ?>