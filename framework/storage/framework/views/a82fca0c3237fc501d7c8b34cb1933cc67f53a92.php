...
<li class="breadcrumb-item active"><?php echo app('translator')->getFromJson('fleet.leave'); ?></li>
<?php $__env->stopSection(); ?>
  ...
  <div class="col-md-12">
    ...
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->getFromJson('fleet.leave'); ?> &nbsp;
          <a href="<?php echo e(route("leave.create")); ?>" class="btn btn-success"> Add Leave </a>
        </h3>
      </div>
        ...
        <table class="table" id="data_table" style="padding-bottom: 15px">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <?php if($row->is_present==1): ?>
                  <span class="badge badge-success">Present</span>
                <?php elseif($row->is_present==2): ?>
                  <span class="badge badge-danger">Absent</span>
                <?php elseif($row->is_present==3): ?>
                  <span class="badge badge-info">1st Half Leave</span>
                <?php elseif($row->is_present==4): ?>
                  <span class="badge badge-primary">2nd Half Leave</span>
                <?php elseif($row->is_present==null): ?>
              ...
              <div class="btn-group">
                ...
                <div class="dropdown-menu custom" role="menu">
                  ...
                  <a class="dropdown-item" href="<?php echo e(url("admin/leave/".$row->id."/edit")); ?>"> <span aria-hidden="true" class="fa fa-edit" style="color: #f0ad4e;"></span> <?php echo app('translator')->getFromJson('fleet.edit'); ?></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/scripyat/public_html/scriptx.in/VehicleMgmt/framework/resources/views/leaves/index.blade.php ENDPATH**/ ?>