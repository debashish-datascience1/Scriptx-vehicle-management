    ...
    <div class="card-body">
      ...
      <div class="tab-content">
        <div class="tab-pane active" id="info-tab">
          <?php echo Form::open(['route' => 'vehicles.store','files'=>true, 'method'=>'post','class'=>'form-block','id'=>'accountForm']); ?>
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <?php echo Form::text('average', null,['class' => 'form-control','required','onkeypress'=>'return isNumber(event,this)']); ?>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <?php echo Form::select('hours',Helper::timeArray(100), null,['class' => 'form-control','required','onkeypress'=>'return isNumber(event,this)','placeholder'=>'Hours']); ?>

                      </div>
                      <div class="col-md-6">
                        <?php echo Form::select('mins',Helper::timeArray(59), null,['class' => 'form-control','required','onkeypress'=>'return isNumber(event,this)','placeholder'=>'Minutes']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/scripyat/public_html/scriptx.in/VehicleMgmt/framework/resources/views/vehicles/create.blade.php ENDPATH**/ ?>