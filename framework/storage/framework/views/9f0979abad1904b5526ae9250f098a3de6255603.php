...
<li class="breadcrumb-item active"><?php echo app('translator')->getFromJson('fleet.unit'); ?></li>
<?php $__env->stopSection(); ?>
  ...
  <div class="col-md-12">
    ...
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->getFromJson('fleet.unit'); ?> &nbsp;
          <a href="<?php echo e(route("unit.create")); ?>" class="btn btn-success"> Add <?php echo app('translator')->getFromJson('fleet.unit'); ?> </a>
        </h3>
      </div>
            ...
            <tr>
              ...
              <div class="btn-group">
                ...
                <div class="dropdown-menu custom" role="menu">
                  ...
                  <a class="dropdown-item" href="<?php echo e(url("admin/unit/".$row->id."/edit")); ?>"> <span aria-hidden="true" class="fa fa-edit" style="color: #f0ad4e;"></span> <?php echo app('translator')->getFromJson('fleet.edit'); ?></a>
              ...
              <?php echo Form::open(['url' => 'admin/unit/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/scripyat/public_html/scriptx.in/VehicleMgmt/framework/resources/views/unit/index.blade.php ENDPATH**/ ?>