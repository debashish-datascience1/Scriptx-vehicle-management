    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <small class="pull-right"> <b><?php echo app('translator')->getFromJson('fleet.date'); ?> : </b> <?php echo e(Helper::getCanonicalDateTime('Y-m-d H:i:s','default')); ?> / <?php echo e(Helper::getCanonicalDateTime('Y-m-d H:i:s')); ?></small>
          </h2>
        </div>
        <!-- /.col -->
      </div>
...
</html><?php /**PATH /home1/scripyat/public_html/scriptx.in/VehicleMgmt/framework/resources/views/reports/customerPaymentPrint.blade.php ENDPATH**/ ?>