        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <?php echo Form::text('date',Helper::indianDateFormat($leave->date),['class' => 'form-control','id'=>'date','required','readonly']); ?>
          ...
          <div class="col-md-4">
              <div class="form-group">
                ...
                <?php echo Form::select('is_present',Helper::getLeaveTypes(),$leave->is_present,['class' => 'form-control remarks','required','placeholder'=>'Select Status','style'=>$style,$isReadOnly]); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.4\htdocs\VehicleMgmt\framework\resources\views/leaves/edit.blade.php ENDPATH**/ ?>