...
<div class="row">
  <div class="col-md-12">
    <div class="card card-info">
      ...
      <div class="card-body">
        <?php echo Form::open(['route' => 'reports.customerPayment','method'=>'post','class'=>'form-inline']); ?>
        ...
        <div class="row">
          ...
          <button type="submit" formaction="<?php echo e(url('admin/print-customer-payment')); ?>" class="btn btn-danger"><i class="fa fa-print"></i> <?php echo app('translator')->getFromJson('fleet.print'); ?></button>
          <?php echo Form::close(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/VehicleMgmt/framework/resources/views/reports/customerPayment.blade.php ENDPATH**/ ?>