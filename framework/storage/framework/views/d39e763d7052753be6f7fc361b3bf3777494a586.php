...
<div class="row">
  <div class="col-md-12">
    <div class="card card-info">
      ...
      <div class="card-body">
        <?php echo Form::open(['route' => 'reports.salary-processing','method'=>'post','class'=>'form-inline']); ?>
        ...
        <div class="row newrow">
          <div class="col-md-3">
            <div class="form-group">
              ...
              <?php echo Form::select('driver_id[]',$drivers,$request['driver_id'],['class'=>'form-control fullsize','multiple'=>'multiple','id'=>'driver_id','placeholder'=>'ALL']); ?>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              &nbsp;
              <?php echo Form::select('months',$months,$request['months'],['class'=>'form-control fullsize','required','id'=>'months','placeholder'=>'Select Month']); ?>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              &nbsp;
              <?php echo Form::select('years',$years,$request['years'],['class'=>'form-control fullsize','required','id'=>'years','placeholder'=>'Select Year']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/scripyat/public_html/scriptx.in/VehicleMgmt/framework/resources/views/reports/salary-processing.blade.php ENDPATH**/ ?>