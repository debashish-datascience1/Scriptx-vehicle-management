    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <?php if(!Auth::guest() &&  Auth::user()->user_type!="D" && Auth::user()->user_type != "C" ): ?>
          ...
          <?php if((Request::is('admin/payroll*')) || Request::is('admin/manage-payroll*') || (Request::is('admin/leave*'))): ?>
            <?php ($class="menu-open"); ?>
            <?php ($active="active"); ?>
          ...
          <?php if(in_array(1,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('leave.index')); ?>" class="nav-link <?php if(Request::is('admin/leave*')): ?> active <?php endif; ?>">
          ...
          <?php if(in_array(1,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(route('bank-account.index')); ?>" class="nav-link <?php if(Request::is('admin/bank-account*') &&  !Request::is('admin/bank-account/bulk_pay') && !Request::is('admin/bank-account/bulk_pay/manage') && !Request::is('admin/bank-account/deposit*')): ?> active <?php endif; ?>">
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('accounting.index')); ?>" class="nav-link <?php if(Request::is('admin/accounting*') && !Request::is('admin/accounting/report*') && !Request::is('admin/accounting/transaction-bank')): ?> active <?php endif; ?>">
                  <i class="fa fa-inr nav-icon"></i>
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('accounting.report')); ?>" class="nav-link <?php if(Request::is('admin/accounting/report*')): ?> active <?php endif; ?>">
          ...
          <?php endif; ?>
          <?php if((Request::is('admin/daily-advance*')) || (Request::is('admin/daily-advance/report*'))): ?>
            <?php ($class="menu-open"); ?>
            <?php ($active="active"); ?>
          ...
          <?php if(in_array(1,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('daily-advance.report')); ?>" class="nav-link <?php if(Request::is('admin/daily-advance/report*')): ?> active <?php endif; ?>">
          ...
          <?php if(in_array(4,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('reports.customerPayment')); ?>" class="nav-link <?php if(Request::is('admin/reports/customerPayment')): ?> active <?php endif; ?>">
                  <i class="fa fa-book nav-icon"></i>
                  <p><?php echo app('translator')->getFromJson('menu.customerPayment'); ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(route('reports.vendorPayment')); ?>" class="nav-link <?php if(Request::is('admin/reports/vendorPayment')): ?> active <?php endif; ?>">
                  <i class="fa fa-book nav-icon"></i>
          ...
          <?php if(in_array(5,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('fuel.report')); ?>" class="nav-link <?php if(Request::is('admin/fuel/report') && !Request::is('admin/fuel/report-vehicle')): ?> active <?php endif; ?>">
                  <i class="fa fa-exclamation nav-icon"></i>
                  <p>Fuel Type Report</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(route('fuel.report-vehicle')); ?>" class="nav-link <?php if(Request::is('admin/fuel/report-vehicle')): ?> active <?php endif; ?>">
                  <i class="fa fa-file-text-o nav-icon"></i>
                  <p>Vehicle Fuel Type Report</p>
                </a>
              </li>
            </ul>
          </li> <?php endif; ?>
          ...
          <?php if(in_array(6,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('vendors.report')); ?>" class="nav-link <?php if((Request::is('admin/vendors/report') && !(Request::is('admin/vendors/create')))): ?> active <?php endif; ?>">
                  <i class="fa fa-file-text-o nav-icon"></i>
                  <p>Vendor Report</p>
                </a>
              </li>
          ...
          <?php if(in_array(7,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo e(url('admin/work_order/report-vendor')); ?>" class="nav-link <?php if(Request::is('admin/work_order/report-vendor')): ?> active <?php endif; ?>">
...
</html><?php /**PATH /var/www/html/VehicleMgmt/framework/resources/views/layouts/app.blade.php ENDPATH**/ ?>