        ...
        <table class="table" id="data_table">
          ...
          <?php $__currentLoopData = $bankAccount; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td style="font-weight: 600"><?php echo e(Hyvikk::get('currency')); ?> <?php echo e(number_format($row->starting_amount,2,'.','')); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/VehicleMgmt/framework/resources/views/bank_account/index.blade.php ENDPATH**/ ?>