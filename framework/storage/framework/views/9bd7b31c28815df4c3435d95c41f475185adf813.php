...
<?php $__env->startSection("breadcrumb"); ?>
    ...
    <li class="breadcrumb-item active">Add Fastag Entry</li>
<?php $__env->stopSection(); ?>
    ...
    <div class="col-md-12">
        <div class="card card-success">
            <div class="card-header with-border">
                <h3 class="card-title">Add Fastag Entry</h3>
            </div>
            ...
            <div class="card-body">
                ...
                <?php echo Form::open(['route' => 'fastag.store', 'method' => 'post', 'id' => 'fastagForm']); ?>

                <?php echo Form::hidden('grand_total', '0.00', ['id' => 'grand_total_input']); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('date[]', null, ['class' => 'form-control datepicker', 'required', 'autocomplete' => 'off']); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('toll_gate_name[]', null, ['class' => 'form-control', 'required']); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::number('amount[]', null, ['class' => 'form-control amount-input', 'required', 'step' => '0.01']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.4\htdocs\VehicleMgmt\framework\resources\views/fastag/create.blade.php ENDPATH**/ ?>