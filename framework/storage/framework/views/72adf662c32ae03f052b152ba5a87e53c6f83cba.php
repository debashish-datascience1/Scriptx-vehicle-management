...
<li class="breadcrumb-item active">Edit <?php echo app('translator')->getFromJson('fleet.other_advance'); ?></li>
<?php $__env->stopSection(); ?>
  ...
  <div class="col-md-12">
    <div class="card card-success">
      <div class="card-header with-border">
        <h3 class="card-title">Edit <?php echo app('translator')->getFromJson('fleet.other_advance'); ?></h3>
      </div>
      ...
      <div class="card-body">
        ...
        <?php echo Form::model($otherAdvance,['route' => ['other-advance.update',$otherAdvance->id],'files'=>true,'method'=>'PATCH']); ?>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <?php echo Form::text('date',Helper::indianDateFormat($otherAdvance->date),['class' => 'form-control','id'=>'date','required','readonly']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.4\htdocs\VehicleMgmt\framework\resources\views/other_advance/edit.blade.php ENDPATH**/ ?>