  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        ...
        &nbsp;
        <a href="<?php echo e(route('loan-give.create')); ?>" class="btn btn-success"><?php echo app('translator')->getFromJson('fleet.loan_give'); ?></a>
        </h3>
      </div>
              ...
              <td>
                <div class="btn-group">
                  ...
                  <div class="dropdown-menu custom" role="menu">
                    <a class="dropdown-item" href="<?php echo e(route('loan-give.show', $loanTake->id)); ?>">
                      <span aria-hidden="true" class="fa fa-eye" style="color: #398439;"></span> <?php echo app('translator')->getFromJson('fleet.details'); ?>
                    </a>
                    <a class="dropdown-item" href="<?php echo e(route('loan-give.edit', $loanTake->id)); ?>">
                      <span aria-hidden="true" class="fa fa-edit" style="color: #f0ad4e;"></span> <?php echo app('translator')->getFromJson('fleet.edit'); ?>
                    </a>
                    <a class="dropdown-item" href="<?php echo e(route('loan-give.return', $loanTake->id)); ?>">
                      <span aria-hidden="true" class="fa fa-undo" style="color: #3c8dbc;"></span> <?php echo app('translator')->getFromJson('fleet.collect'); ?>
                    </a>
                    <?php echo Form::open(['url' => 'admin/loan-give/'.$loanTake->id, 'method' => 'DELETE', 'class' => 'form-horizontal', 'id' => 'form_'.$loanTake->id]); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.4\htdocs\VehicleMgmt\framework\resources\views/loan_give/index.blade.php ENDPATH**/ ?>