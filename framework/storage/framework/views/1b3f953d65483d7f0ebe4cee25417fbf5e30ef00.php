...
<script type="text/javascript">
  $(function(){
    $(".vevent").click(function(){
      var id = $(this).data("id");
      // console.log(id)
        $("#viewModal .modal-body").load('<?php echo e(url("admin/vendors/view_event")); ?>/'+id,function(res){
          // console.log(res)
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/scripyat/public_html/scriptx.in/VehicleMgmt/framework/resources/views/vendors/index.blade.php ENDPATH**/ ?>