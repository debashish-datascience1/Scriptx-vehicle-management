    ...
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">Manage Order Heads &nbsp;
          <a href="<?php echo e(route("work-order-category.create")); ?>" class="btn btn-success"> Add Order Head </a>
        </h3>
      </div>
      ...
      <div class="card-body table-responsive">
        <table class="table" id="data_table" style="padding-bottom: 15px">
          ...
          <tbody>
            <?php $__currentLoopData = $orderCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              <td></td>
              ...
              <td><?php echo e(Helper::getCanonicalDate($row->created_at,'default')); ?></td>
              <td>
              <div class="btn-group">
                ...
                <div class="dropdown-menu custom" role="menu">
                  ...
                  <a class="dropdown-item" href="<?php echo e(url("admin/work-order-category/".$row->id."/edit")); ?>"> <span aria-hidden="true" class="fa fa-edit" style="color: #f0ad4e;"></span> <?php echo app('translator')->getFromJson('fleet.edit'); ?></a>
                  <?php echo Form::open(['url' => 'admin/work-order-category/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]); ?>
...
<script type="text/javascript">
  $(".vevent").click(function(){
    var id = $(this).data("id");
    // console.log(id)
      $("#viewModal .modal-body").load('<?php echo e(url("admin/leave/view_event")); ?>/'+id,function(res){
        // console.log(res)
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/scripyat/public_html/scriptx.in/VehicleMgmt/framework/resources/views/work_order_categories/index.blade.php ENDPATH**/ ?>