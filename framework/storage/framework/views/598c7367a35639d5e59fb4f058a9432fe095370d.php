      ...
      <div class="card-body">
        ...
        <div class="col-md-4">
            <div class="form-group">
              ...
              <div class="input-group">
                <div class="input-group-prepend">
                  <?php echo Form::select('adphone_code',$phone_code,$driver->getMeta('adphone_code'),['class' => 'form-control code','required','style'=>'width:80px;']); ?>

                </div>
                <?php echo Form::number('adphone', $driver->getMeta('adphone'),['class' => 'form-control','required']); ?>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class="input-group date">
                ...
                <?php echo Form::text('issue_date', $driver->getMeta('issue_date'),['class' => 'form-control','required','readonly']); ?>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class="input-group date">
                <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-calendar"></i></span></div>
                <?php echo Form::text('exp_date', $driver->getMeta('exp_date'),['class' => 'form-control','required','readonly']); ?>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class="input-group date">
              <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-calendar"></i></span></div>
              <?php echo Form::text('start_date', $driver->getMeta('start_date'),['class' => 'form-control','readonly']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/VehicleMgmt/framework/resources/views/drivers/edit.blade.php ENDPATH**/ ?>