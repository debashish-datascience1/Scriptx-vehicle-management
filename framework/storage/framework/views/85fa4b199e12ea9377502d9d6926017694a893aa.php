                                ...
                                <tbody>
                                    ...
                                    if(!empty($v->getMeta($docName[2]))){
                                        ...
                                        if(!empty($v->getMeta($docName[0])) && !empty($v->getMeta($docName[1]))){
                                            ...
                                            $expirationDate = date('d-m-Y', strtotime($v->getMeta($docName[2])));
                                            $earlyRenewalDate = date('d-m-Y', strtotime($v->getMeta($docName[2]) . ' -1 month'));
                                    ...
                                    <tr>
                                        ...
                                        <?php if($expirationDateSet): ?>
                                                ...
                                                <?php else: ?>
                                                    <td colspan="5" align="center">
                                                        <?php if(!empty($expirationDate)): ?>
                                                            ...
                                                            <p>Early renewal available from: <?php echo e($earlyRenewalDate); ?></p>
                                                            <?php if($daysLeft > 0): ?>
                                            ...
                                            <?php else: ?>
                                                <td colspan="5" align="center">
                                                    <label for=""><?php echo e($doc->label); ?> duration and unit is not set</label> 
                                                    <a href="../vehicles/<?php echo e($v->id); ?>/edit?tab=insurance" target="_blank">click here</a> to set
                                                </td>
                                            <?php endif; ?>
                                        <?php else: ?>
                                            <td colspan="5" align="center">
                                                <label for=""><?php echo e($doc->label); ?> expiration date is not set</label> 
                                                <a href="../vehicles/<?php echo e($v->id); ?>/edit?tab=insurance" target="_blank">click here</a> to set
                                            </td>
                                        <?php endif; ?>
                                    </tr>
