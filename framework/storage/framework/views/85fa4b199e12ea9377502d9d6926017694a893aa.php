                                        ...
                                        <?php $__currentLoopData = $docparams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                                ...
                                                if (!empty($v->getMeta($docName[2]))) {
                                                    ...
                                                    if (
                                                        !empty($v->getMeta($docName[0])) &&
                                                        !empty($v->getMeta($docName[1]))
                                                    ) {
                                                        ...
                                                        $expirationDate = date(
                                                            'd-m-Y',
                                                            strtotime($v->getMeta($docName[2])),
                                                        );
                                                        $earlyRenewalDate = date(
                                                            'd-m-Y',
                                                            strtotime($v->getMeta($docName[2]) . ' -1 month'),
                                                        );
                                                    } else {
                                            ...
                                            <tr>
                                                ...
                                                <?php if($expirationDateSet): ?>
                                                    <?php if($durationUnitSet): ?>
                                                        <?php if($lastDay): ?>
                                                            <td>
                                                                <?php echo Form::text("date[$v->id][$doc->id]", null, [
                                                            ...
                                                            <td>
                                                                <?php echo Form::text("payment_date[$v->id][$doc->id]", null, [
                                                            ...
                                                            <td>
                                                                <?php echo Form::text("amount[$v->id][$doc->id]", null, [
                                                                ...
                                                                <?php echo Form::select("vendor[$v->id][$doc->id]", $vendors, null, [
                                                            ...
                                                            <td>
                                                                <?php echo Form::select("bank[$v->id][$doc->id]", $bankAccount, null, [
                                                                ...
                                                                <?php echo Form::select("method[$v->id][$doc->id]", $method, null, [
                                                            ...
                                                            <td>
                                                                <?php echo Form::text("ddno[$v->id][$doc->id]", null, [
                                                                    'class' => 'form-control ddno',
                                                                    'required',
                                                                    'style' => 'margin-top: 9px;',
                                                                    'placeholder' => 'Reference No.',
                                                                ]); ?>

                                                                <?php echo Form::textarea("remarks[$v->id][$doc->id]", null, [
                                                                    'class' => 'form-control remarks',
                                                                    'style' => 'height:100px;resize:none;margin-top:7px;',
                                                            ...
                                                            <td>
                                                                <input type="button" value="Renew"
                                                                    class="btn btn-success renew_btn">
                                                                <input type="hidden" name="hiddenInput"
                                                                    class="singleVehicleId" value="<?php echo e($v->id); ?>">
                                                            </td>
                                                        <?php else: ?>
                                                            <td colspan="6" align="center">
                                                                <?php if(!empty($expirationDate)): ?>
                                                                    <p>Document expires on: <?php echo e($expirationDate); ?></p>
                                                                    <p>Early renewal available from:
                                                                        <?php echo e($earlyRenewalDate); ?></p>
                                                                    <?php if($daysLeft > 0): ?>
                                                                        <?php echo app('translator')->getFromJson('fleet.after'); ?> <?php echo e($daysLeft); ?>

                                                                        <?php echo app('translator')->getFromJson('fleet.days'); ?>
                                                                    <?php endif; ?>
                                                                <?php endif; ?>
                                                            </td>
                                                        <?php endif; ?>
                                                    <?php else: ?>
                                                        <td colspan="6" align="center">
                                                            <label for=""><?php echo e($doc->label); ?> duration and unit
                                                                is not set</label>
                                                            <a href="../vehicles/<?php echo e($v->id); ?>/edit?tab=insurance"
                                                                target="_blank">click here</a> to set
                                                        </td>
                                                    <?php endif; ?>
                                                <?php else: ?>
                                                    <td colspan="6" align="center">
                                                        <label for=""><?php echo e($doc->label); ?> expiration date is
                                                            not set</label>
                                                        <a href="../vehicles/<?php echo e($v->id); ?>/edit?tab=insurance"
                                                            target="_blank">click here</a> to set
                                                    </td>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH C:\xampp7.4\htdocs\VehicleMgmt\framework\resources\views/vehicle_docs/renew_list.blade.php ENDPATH**/ ?>