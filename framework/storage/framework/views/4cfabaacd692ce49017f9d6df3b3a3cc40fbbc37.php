        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <option value="<?php echo e($vehicle->id); ?>" data-driver="<?php echo e($vehicle->driver_id); ?>" data-mileage="<?php echo e($vehicle->average); ?>" data-tmileage="<?php echo e(trim(Helper::digitsToTime($vehicle->time_average))); ?>" <?php if($vehicle->id==$data->vehicle_id): ?> selected <?php endif; ?>> <?php echo e($vehicle->make); ?> - <?php echo e($vehicle->model); ?> - <?php echo e($vehicle->license_plate); ?></option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <?php echo Form::select('mileage_type',$mileagetypes,$data->mileage_type,['class'=>'form-control','min'=>1,'required','onchange'=>'return checkTop()']); ?>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 form-group">
                      ...
                      <span id="time_ltr"><?php echo e(Helper::digitsToTime($data->tmileage)); ?></span>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-4 form-group">
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/scripyat/public_html/scriptx.in/VehicleMgmt/framework/resources/views/bookings/edit.blade.php ENDPATH**/ ?>