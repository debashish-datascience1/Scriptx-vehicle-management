...
<head>
  ...
  <title><?php echo e(Hyvikk::get('app_name')); ?> - Fuel Purchase Report</title>
  ...
  <div class="wrapper">
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="col-md-6">
            <p><strong>Vendor:</strong> <?php echo e($vendor->name); ?></p>
            <p><strong>Fuel Type:</strong> <?php echo e($fuel_type_name); ?></p>
          </div>
...
</html><?php /**PATH C:\xampp7.4\htdocs\VehicleMgmt\framework\resources\views/reports/print-fuel-purchase.blade.php ENDPATH**/ ?>