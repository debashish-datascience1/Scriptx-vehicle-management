        ...
        <div class="col-md-12">
            <div class="card card-warning">
                ...
                <div class="card-body">
                    ...
                    <?php echo Form::open([
                        'route' => ['vehicle-docs.update', $doc->id],
                        'method' => 'PUT',
                        'id' => 'editDocForm',
                        'files' => true,
                    ]); ?>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo Form::select('vehicle_id', $vehicles, $doc->vehicle_id, [
                                    'class' => 'form-control',
                                    'id' => 'vehicle_id',
                                    'required',
                                ]); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo Form::text('date', date('d-m-Y', strtotime($doc->date)), [
                                    'class' => 'form-control date',
                                    'id' => 'date',
                                    'required',
                                    'autocomplete' => 'off',
                                    'data-id' => $doc->vehicle_id,
                                    'data-doc' => $doc->param_id,
                                ]); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo Form::label('payment_date', 'Payment Date', ['class' => 'form-label']); ?>

                            <?php echo Form::text('payment_date', $doc->payment_date ? date('d-m-Y', strtotime($doc->payment_date)) : null, [
                                'class' => 'form-control date',
                                'id' => 'payment_date',
                                'autocomplete' => 'off',
                            ]); ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?php echo Form::select('vendor', $vendors, $doc->vendor_id, [
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?php echo Form::select('bank', $bankAccount, $doc->transaction->bank_id, [
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?php echo Form::number('amount', $doc->amount, [
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?php echo Form::select('method', $method, $doc->method, [
            ...
            $("body").on("focus", ".date", function() {
                ...
                $(this).datepicker({
                    ...
                    onSelect: function(date) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo e(route('vehicle-docs.getNextEdit')); ?>",
                            data: dataSet,
