                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo Form::select('customer_id', $customers, $request['customer_id'] ?? null, [
                                    'class' => 'form-control',
                                    'id' => 'customer_id',
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <button type="submit" formaction="<?php echo e(url('admin/print-customer-payment')); ?>"
                                formtarget="_blank" class="btn btn-danger print_report"><i class="fa fa-print"></i>
                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <div class="card-body table-responsive">
                                            ...
                                            <td>
                                                <?php if($row->param_id == 18): ?>
                                                    <?php if($row->is_bulk != 1 && $row->booking): ?>
                                                        ...
                                                        on
                                                        <?php echo e(Helper::getCanonicalDateTime($row->booking->pickup ?? null, 'default')); ?>
                            ...
                            <table class="table">
                                <tr>
                                    <th style="float:right">Opening Balance : <?php echo e(Hyvikk::get('currency')); ?>

                                        <?php echo e(bcdiv($opening_balance, 1, 2)); ?></th>
                                </tr>
                            </table>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(".where_from").on("click", function() {
                ...
                console.log(id);
                console.log(partsw);
                $("#whereModal .modal-content").load('<?php echo e(url('admin/accounting/where_from')); ?>/' + id,
                    function(res) {
                        typeof partsw != "undefined" ? $(this).css('width', '160%') : $(this).css(
                            'width', '');
                        $("#whereModal").modal({
                            show: true
                        })
            ...
            $(".advance_for").on("click", function() {
                var id = $(this).data("id");
                $("#advanceForModal .modal-body").load('<?php echo e(url('admin/accounting/advance_for')); ?>/' + id,
                    function(res) {
                        $("#advanceForModal").modal({
                            show: true
                        })
                    })
            })
