    ...
    <div class="card card-warning">
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <?php echo Form::text('required_by',Helper::indianDateFormat($data->required_by),['class'=>'form-control','required','readonly']); ?>
        ...
        <?php $__currentLoopData = $data->parts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <!-- <p>Debug Info:</p>
              <ul>
                  <li>Part ID: <?php echo e($item->part_id); ?></li>
                  <li>Quantity: <?php echo e($item->qty); ?></li>
                  <li>Unit Cost: <?php echo e($item->price); ?></li>
                  <li>Is Own: <?php echo e($item->is_own); ?></li>
                  <li>Tyre Used: <?php echo e($item->tyre_used); ?></li>
                  <li>Non-stock Tyre Numbers: <?php echo e($item->non_stock_tyre_numbers); ?></li>
              </ul> -->
              <div class="row parts-row">
                  ...
                  <div class="col-md-2">
                      <div class="form-group">
                          ...
                          <?php echo Form::select('tyre_numbers[]', [], $item->tyre_used, ['class' => 'form-control tyre_numbers', 'id' => 'tyre_numbers','multiple' => 'multiple', 'placeholder' => 'Select Tyre Number', 'data-selected' => $item->tyre_used]); ?>
                  ...
                  <div class="col-md-2">
                      <div class="form-group">
                          ...
                          <?php echo Form::text('manual_tyre_numbers[]', $item->is_own == 2 ? $item->non_stock_tyre_numbers : null, ['class' => 'form-control manual_tyre_numbers', 'id' => 'manual_tyre_numbers', 'placeholder' => 'Enter comma-separated numbers']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.4\htdocs\VehicleMgmt\framework\resources\views/work_orders/edit.blade.php ENDPATH**/ ?>