...
<li class="breadcrumb-item active">Edit <?php echo app('translator')->getFromJson('fleet.parts'); ?></li>
<?php $__env->stopSection(); ?>
  ...
  <div class="col-md-12">
    <div class="card card-success">
      <div class="card-header">
        <h3 class="card-title">Edit <?php echo app('translator')->getFromJson('fleet.parts'); ?></h3>
      </div>
      ...
      <div class="card-body">
          ...
          <?php echo Form::model($data,['route' => ['parts.update',$data->id],'method'=>'PATCH','files'=>true]); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.4\htdocs\VehicleMgmt\framework\resources\views/parts/edit.blade.php ENDPATH**/ ?>