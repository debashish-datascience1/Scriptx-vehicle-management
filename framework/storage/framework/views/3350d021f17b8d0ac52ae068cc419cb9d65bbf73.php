        ...
        <div class="col-md-12">
          <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <th colspan="<?php echo e($is_vendor ? 4 : 5); ?>"></th>
                    <th>Grand Total</th>
                    
                    <th><?php echo e(Hyvikk::get('currency')); ?> <?php echo e(number_format(round($fuelTotal),2)); ?></th>
                </tr>
            </tbody>
            <tfoot>
          </table>
...
</html><?php /**PATH /var/www/html/VehicleMgmt/framework/resources/views/vendors/report-print.blade.php ENDPATH**/ ?>