            ...
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  ...
                  <?php echo Form::text('company_gst', null,['class' => 'form-control']); ?>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <?php echo Form::textarea('address', null,['class' => 'form-control','size'=>'30x2','style'=>'resize:none;height:100px;']); ?>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <?php echo Form::text('opening_balance', null,['class' => 'form-control opening_balance','id'=>'opening_balance','placeholer'=>'Enter Opening Balance','onkeypress'=>'return isNumberNegative(event,this)']); ?>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <?php echo Form::textarea('opening_remarks', null,['class' => 'form-control','size'=>'30x2','style'=>'resize:none;height:100px;']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/scripyat/public_html/scriptx.in/VehicleMgmt/framework/resources/views/customers/create.blade.php ENDPATH**/ ?>