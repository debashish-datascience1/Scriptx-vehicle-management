        ...
        <div class="row newrow">
          <div class="col-md-3">
            <div class="form-group">
              ...
              <?php echo Form::select('vehicle_id',$vehicles,$request['vehicle_id'] ?? null,['class'=>'form-control fullsize','id'=>'driver_id','placeholder'=>'Select Vehicle']); ?>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <?php echo Form::text('reference_no',$request['reference_no'] ?? null,['class'=>'form-control fullsize','id'=>'reference_no','placeholder'=>'Please Enter Reference No.']); ?>
        ...
        <div class="row newrow">
          <div class="col-md-3">
            <div class="form-group">
              ...
              <?php echo Form::text('from_date',$request['from_date'] ?? null,['class'=>'form-control fullsize','id'=>'from_date','placeholder'=>'Please Select From Date','readonly']); ?>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <?php echo Form::text('to_date',$request['to_date'] ?? null,['class'=>'form-control fullsize','id'=>'to_date','placeholder'=>'Please Select To Date','readonly']); ?>
          ...
          <div class="col-md-1">
            <div class="form-group">
              ...
              <?php echo Form::select('search_type',['date'=>'Due Date','pay_date'=>'Paid Date'],$request['search_type'] ?? null,['class'=>'form-control fullsize','id'=>'search_type']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.4\htdocs\VehicleMgmt\framework\resources\views/reports/vehicle-emi.blade.php ENDPATH**/ ?>