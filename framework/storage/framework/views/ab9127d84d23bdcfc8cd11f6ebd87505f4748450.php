        ...
        <div class="col-md-12">
            <div class="card card-warning">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                                ...
                                <select id="vehicle_id" name="vehicle_id" class="form-control xxhvk" required>
                                    <?php $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($vehicle->id); ?>"
                                            <?php if($data->vehicle_id == $vehicle->id): ?> selected <?php endif; ?>><?php echo e($vehicle->make); ?> -
                                            <?php echo e($vehicle->model); ?> - <?php echo e($vehicle->license_plate); ?> </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class='input-group'>
                                    ...
                                    <?php echo Form::text('date', Helper::indianDateFormat($data->date), [
                                        'class' => 'form-control',
                                        'required',
                                        'readonly',
                                    ]); ?>
                                ...
                                <div class="col-md-6">
                                    <label class="switch">
                                        <input type="checkbox" name="complete" value="1"
                                            <?php if($data->complete == '1'): ?> checked <?php endif; ?>>
                                    ...
                                    <select id="vendor_name" name="vendor_name" class="form-control" required>
                                        ...
                                        <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($vendor->id); ?>"
                                                <?php if($data->vendor_name == $vendor->id): ?> selected <?php endif; ?>> <?php echo e($vendor->name); ?>
                            ...
                            <div class="card card-solid">
                                ...
                                <div class="card-body">
                                    ...
                                    <small class="smallfuel">Total Fuel Price &nbsp;<span
                                            ...
                                            class="fueltot"><?php echo e(number_format($data->qty * $data->cost_per_unit, 2, '.', '')); ?></span></small>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <?php echo Form::text('total_amount', $data->grand_total, [
                                                        'class' => 'form-control',
                                                        'id' => 'total_amount',
                                                        'readonly',
                                                    ]); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php echo Form::submit(__('fleet.update'), ['class' => 'btn btn-warning', 'id' => 'addBtn']); ?>
