    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <h5>Vehicle : <strong><?php echo e($vehicle_name); ?></strong> &nbsp;&nbsp;&nbsp; |&nbsp;&nbsp;&nbsp;  Fuel : <strong><?php echo e($fuel_name); ?></strong></h5>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
...
</html><?php /**PATH /home1/scripyat/public_html/scriptx.in/VehicleMgmt/framework/resources/views/fuel/fuelVendorDetails-print.blade.php ENDPATH**/ ?>