  ...
  <div class="col-md-12">
    <div class="card card-info">
      ...
      <div class="card-body">
        ...
        <hr>
        <h4><?php echo app('translator')->getFromJson('fleet.return_history'); ?></h4>
        <table class="table">
          <thead>
            <tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.4\htdocs\VehicleMgmt\framework\resources\views/loan_take/show.blade.php ENDPATH**/ ?>