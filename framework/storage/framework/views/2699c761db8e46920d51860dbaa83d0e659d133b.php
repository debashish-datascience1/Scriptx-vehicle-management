<form action="<?php echo e(url('admin/bookings/modal_save')); ?>" method="POST">
...
<table class="table table-striped">
            ...
            <table class="table table-bordered">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e(Helper::getCanonicalDateTime($data->pickup)); ?></td>
                    </tr>
                </tbody>
            </table>
        </tr>
            ...
            <table class="table table-bordered">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input type="number" class="form-control" name="total_adv" id="total_adv" value="<?php echo e($data->getMeta('advance_pay')); ?>" readonly>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <input type="number" class="form-control" name="others" id="others" value="<?php echo e($data->getMeta('advance_pay')); ?>" readonly style="margin-bottom: 10px;">
    ...
    <?php else: ?>
        <tr>
            <td style="color: red; text-align:center" colspan="2">No advance was given to <i><?php echo e($data->driver->name); ?></i> for this booking..</td>
        </tr>
        <tr>
            <td colspan="2">
...
</form>    <?php /**PATH /home1/scripyat/public_html/scriptx.in/VehicleMgmt/framework/resources/views/bookings/markcomplete.blade.php ENDPATH**/ ?>