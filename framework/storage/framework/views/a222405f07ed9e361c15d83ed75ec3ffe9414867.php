...
<div class="row">
  <div class="col-md-12">
    <div class="card card-info">
      ...
      <div class="card-body">
        <?php echo Form::open(['route' => 'bank-account.bulk_receive','method'=>'post','class'=>'form-inline']); ?>
        ...
        <div class="row">
          <div class="col-md-4 mb-2">
            <div class="form-group">
              ...
              <?php echo Form::select('customer',$customers,$customer,['class'=>'form-control inputlen','placeholder'=>'Select Customer','required']); ?>
...
<div class="row">
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">
          <?php if(Request::is("admin/bank-account/bulk_receive")): ?>
          Bulk Receive
          <?php else: ?>
      ...
      <?php echo Form::open(['route' => 'bulk_receive.store','method'=>'post','id'=>'formSub']); ?>
        ...
        <table class="table table-bordered table-striped table-hover"  id="">
          ...
          <tbody>
            <?php if(count($transactions)>0): ?>
                ...
                <td><?php echo e(Helper::getCanonicalDateTime($row->dateof,'default')); ?></td>
                ...
                <td class="remnants">
                  ...
                  <div class='input-group date'>
                    ...
                    <?php echo Form::text("price[$row->id]",null,['class'=>'form-control price','disabled','placeholder'=>'Price...','step'=>'any','onkeypress'=>'return isNumber(event,this)']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/scripyat/public_html/scriptx.in/VehicleMgmt/framework/resources/views/bank_account/bulk_receive.blade.php ENDPATH**/ ?>