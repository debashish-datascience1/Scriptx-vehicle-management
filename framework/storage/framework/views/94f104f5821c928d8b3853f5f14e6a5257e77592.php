...
<div role="tabpanel">
    <ul class="nav nav-pills">
        ...
        <li class="nav-item"><a href="#prev-tab" data-toggle="tab" class="nav-link custom_padding"> Advance History <i class="fa"></i></a>
        </li>
    </ul>
			...
			<table class="table table-striped">
                ...
                <?php $__currentLoopData = $historys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <th><?php echo e(Hyvikk::get('currency')); ?> <?php echo e($hist->amount); ?></th>
                        <td>
...
</div><?php /**PATH /var/www/html/VehicleMgmt/framework/resources/views/daily_advance/view_event.blade.php ENDPATH**/ ?>