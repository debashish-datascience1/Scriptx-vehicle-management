    ...
    <div class="card card-warning">
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <div class="form-group">
              <?php echo Form::label('is_itemno',__('fleet.addItemNo')." ?", ['class' => 'form-label']); ?>

              <?php echo Form::select('is_itemno',[1=>'Yes',0=>'No'],$data->is_itemno,['class'=>'form-control','required']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/scripyat/public_html/scriptx.in/VehicleMgmt/framework/resources/views/parts_category/edit.blade.php ENDPATH**/ ?>