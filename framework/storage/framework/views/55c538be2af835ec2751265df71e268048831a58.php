                    ...
                    <div class="row newrow">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <?php echo Form::select('vehicle_id', $vehicles, $request['vehicle_id'] ?? null, [
                                    'class' => 'form-control',
                                    'id' => 'vehicle_id',
                    ...
                    <div class="row newrow">
                        <div class="col-md-12">
                            <button type="button" id="generateReport" class="btn btn-info"
                                style="margin-right: 10px"><?php echo app('translator')->getFromJson('fleet.generate_report'); ?></button>
                            <button type="submit" formaction="<?php echo e(url('admin/print-vehicle-overview-report')); ?>"
                                ...
                                <table class="table table-bordered table-striped table-hover" id="fleetOverviewTable">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $summary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e(($pagination->currentPage() - 1) * $pagination->perPage() + $loop->iteration); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\VehicleMgmt\framework\resources\views/vehicles/report.blade.php ENDPATH**/ ?>