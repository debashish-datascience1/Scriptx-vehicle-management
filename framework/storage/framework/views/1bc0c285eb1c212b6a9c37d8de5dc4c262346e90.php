...
<style type="text/css">
  ...
  .badge-view{background: #3b6aeb;color:#fff !important;cursor: pointer;}
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
               ...
               <a class="mybtn vevent badge badge-view" data-id="<?php echo e($row->id); ?>" data-toggle="modal" data-target="#viewModal" title="<?php echo app('translator')->getFromJson('fleet.view'); ?>"> <?php echo e($row->transaction_id); ?></a>
                <br>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/VehicleMgmt/framework/resources/views/transactions/index-bank.blade.php ENDPATH**/ ?>