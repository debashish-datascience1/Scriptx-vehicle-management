    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <h4><strong><?php echo e($driver_name); ?></strong></h4>
          <?php endif; ?>
          ...
          <?php endif; ?>
          <small><h4><strong><?php echo e($from_date); ?> - <?php echo e($to_date); ?></strong></h4></small>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
...
</html><?php /**PATH C:\xampp7.4\htdocs\VehicleMgmt\framework\resources\views/reports/print-driveradvance.blade.php ENDPATH**/ ?>