    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          <h3>Vehicle Fuel Type Report</h3>
          <small><?php echo e(Helper::getCanonicalDate($date['from_date'],'default')); ?></small> -
            ...
            <tbody>
                <?php $__currentLoopData = $fuelv; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e(Helper::properDecimals($row->qty)); ?></td>
                ...
                <tr>
                    <th colspan="2"></th>
                    <th>Grand Total</th>
                    <th><?php echo e(Helper::properDecimals($grandtotal_qty)); ?></th>
                    <th><?php echo e(Hyvikk::get('currency')); ?> <?php echo e(Helper::properDecimals($grandtotal_cost)); ?></th>
                </tr>
            </tbody>
            <tfoot>
          </table>
...
</html><?php /**PATH /home1/scripyat/public_html/scriptx.in/VehicleMgmt/framework/resources/views/fuel/report-vehicle-print.blade.php ENDPATH**/ ?>