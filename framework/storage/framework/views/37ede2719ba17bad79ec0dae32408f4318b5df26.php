                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <?php echo Form::select('vehicle_id[]', $vehicles, null, [
                                    'class' => 'form-control',
                                    'id' => 'vehicle_id',
                                    'required',
                                    'multiple' => 'multiple',
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("body").on("click", ".renew_btn", function() {
                ...
                var payment_date = self.closest("tr").find(".payment_date");
                ...
                if (!blankTest.test(payment_date.val())) {
                ...
                if (confirm("Are you sure ?")) {
                    var dataSet = {
                        ...
                        date: date.val(),
                        payment_date: payment_date.val(), // Make sure payment_date is included
                        amount: amount.val(),
                        vendor: vendor.val(),
                        bank: bank.val(),
                        method: method.val(),
                        ddno: ddno.val(),
                        vehicle_id: singleVehicleId.val(),
                        doc_id: doc_id,
                        remarks: remarks.val()
                    }
                    // console.table(dataSet);
                    // return false;
                    $.post("<?php echo e(route('vehicle-docs.single-save')); ?>", dataSet)
                        .done(function(result) {
                            console.log('Response:', result); // Added for debugging
                            if (result.status) {
                                alert(result.msg)
                                self.replaceWith(
        ...
        $(this).datepicker({
            ...
            $("#vehicle_id").on("change", function() {
                ...
                if (darr.length == 0) $('.blank').html('');
                    ...
                    // console.log(darr)
                    $('.blank').load('<?php echo e(url('admin/vehicle-docs/renew-vehicles')); ?>/' + darr, function(
                        result) {
                        // console.log(result);
                    })
                };
