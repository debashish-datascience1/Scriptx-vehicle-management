...
<body onload="window.print();">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <?php if(!empty($vehicle_id) && !isset($all_vehicles)): ?>
                        <h4><?php echo e($vehicle->make); ?>-<?php echo e($vehicle->model); ?>- <strong><?php echo e($vehicle->license_plate); ?></strong>
                        </h4>
                    <?php endif; ?>
                ...
                <div class="col-md-12">
                    <?php if(isset($all_vehicles)): ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover fleet-table"
                                id="fleetOverviewTable">
                                <thead>
                                    <tr>
                                        <th>SL No</th>
                                        <th>Vehicle</th>
                                    ...
                                    <?php $__currentLoopData = $summary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e(Hyvikk::get('currency')); ?>
                                                ...
                                                <?php echo e(number_format($vehicle_data['total_revenue'], 2)); ?></td>
                                            <td><?php echo e(Hyvikk::get('currency')); ?>

                                                <?php echo e(number_format($vehicle_data['fuel_cost'], 2)); ?></td>
                                            <td><?php echo e(Hyvikk::get('currency')); ?>

                                                <?php echo e(number_format($vehicle_data['driver_salary'], 2)); ?></td>
                                            <td><?php echo e(Hyvikk::get('currency')); ?>

                                                <?php echo e(number_format($vehicle_data['other'], 2)); ?></td>
                                            <td><?php echo e(Hyvikk::get('currency')); ?>
                                            ...
                                            <td><?php echo e(Hyvikk::get('currency')); ?>
                                                ...
                                                <?php echo e(number_format($vehicle_data['net_profit'], 2)); ?></td>
                                        </tr>
                                ...
                                <tfoot>
                                    <tr class="total-row">
                                        ...
                                        <th><?php echo e(Hyvikk::get('currency')); ?>
                                            ...
                                            <?php echo e(number_format(collect($summary)->sum('total_revenue'), 2)); ?></th>
                                        <th><?php echo e(Hyvikk::get('currency')); ?>

                                            <?php echo e(number_format(collect($summary)->sum('fuel_cost'), 2)); ?></th>
                                        <th><?php echo e(Hyvikk::get('currency')); ?>

                                            <?php echo e(number_format(collect($summary)->sum('driver_salary'), 2)); ?></th>
                                        <th><?php echo e(Hyvikk::get('currency')); ?>

                                            <?php echo e(number_format(collect($summary)->sum('other'), 2)); ?></th>
                                        <th><?php echo e(Hyvikk::get('currency')); ?>
                                        ...
                                        <th><?php echo e(Hyvikk::get('currency')); ?>
                                            ...
                                            <?php echo e(number_format(collect($summary)->sum('net_profit'), 2)); ?></th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                        ...
                        <table class="table table-bordered table-striped table-hover" id="myTable1">
                            ...
                            <tr>
                                <td align="center" style="font-size:23px;">
                                    ...
                                    <?php endif; ?>
                                    <?php if(!empty($vehicle->driver)): ?>
                                        <h6><?php echo e(Helper::getCanonicalDate($from_date)); ?> -
                                            <?php echo e(Helper::getCanonicalDate($to_date)); ?></h6>
                                    <?php endif; ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <table class="table table-bordered table-striped">
                                    ...
                                    <thead>
                                        <tr>
                                            <td colspan="4" align="center" style="font-size:18px;font-weight: 600;">
                                                Bookings</td>
                                        </tr>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <?php else: ?>
                                            <tr>
                                                <td colspan="4" align='center' style="color: red">No Records Found...
                                                </td>
                                            </tr>
                                        <?php endif; ?>
                                    </tbody>
                                            ...
                                            <?php $__currentLoopData = $fuels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $fs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e(array_sum($fs->ltr)); ?>
                                                        ...
                                                        <?php echo e($k != 'Lubricant' ? Hyvikk::get('fuel_unit') : 'pc'); ?></td>
                                                    <td>
                            ...
                            <tr>
                                <table class="table table-bordered table-striped">
                                    ...
                                    <thead>
                                        <tr>
                                            <td colspan="3" align="center" style="font-size:18px;font-weight: 600;">
                                                Driver Advance</td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                                        ...
                                                        <tbody>
                                                            <?php $__currentLoopData = $advances->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $det): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo e(Hyvikk::get('currency')); ?>
                                                                        ...
                                                                        <?php echo e(!empty($det->amount) ? Helper::properDecimals($det->amount) : Helper::properDecimals(0)); ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th><?php echo e(Hyvikk::get('currency')); ?>
                                                                    ...
                                                                    <?php echo e(!empty($advances->amount) ? Helper::properDecimals(array_sum($advances->amount)) : Helper::properDecimals(0)); ?>
                            ...
                            <tr>
                                <table class="table table-bordered table-striped">
                                    ...
                                    <thead>
                                        <tr>
                                            <td colspan="6" align="center" style="font-size:18px;font-weight: 600;">
                                                Work Order</td>
                                        </tr>
                                        <tr>
                                    ...
                                    <tbody>
                                                    ...
                                                    <table class="table table-striped">
                                                        <tr>
                                                            ...
                                                            <td><?php echo e(Hyvikk::get('currency')); ?>
                                                                ...
                                                                <?php echo e(Helper::properDecimals($wo->cgst)); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th>SGST</th>
                                                            <td><?php echo e(Hyvikk::get('currency')); ?>

                                                                <?php echo e(Helper::properDecimals($wo->sgst)); ?></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td><?php echo e(Hyvikk::get('currency')); ?>

                                                    <?php echo e(Helper::properDecimals($wo->grand_total)); ?></td>
                                                                ...
                                                                <?php $__currentLoopData = $partsUsed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><?php echo e(Hyvikk::get('currency')); ?>
                                                                            ...
                                                                            <?php echo e(Helper::properDecimals($pu->total)); ?>
                                        ...
                                        <?php else: ?>
                                            <tr>
                                                <td colspan="6" align='center' style="color: red">No Records Found...
                                                </td>
                                            </tr>
                                        <?php endif; ?>
                                    </tbody>
    ...
    <!-- ./wrapper -->
    <div class="modal fade no-print" id="wheelPriceModal" tabindex="-1" role="dialog"
        aria-labelledby="wheelPriceModalLabel" aria-hidden="true">
    ...
    <div class="modal fade no-print" id="fuelBalanceModal" tabindex="-1" role="dialog"
        aria-labelledby="fuelBalanceModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-info text-white">
...
<?php /**PATH C:\xampp7.4\htdocs\VehicleMgmt\framework\resources\views/vehicles/print_report.blade.php ENDPATH**/ ?>