...
var table = $('#data_tabled').DataTable({
    "processing": true,
    "serverSide": true,
    "ajax":'<?php echo e(route("accounting.getTransactionList")); ?>',
    "columns":[
        {data : 'id'},
        {data : 'trash_id'},
        {data : 'from'},
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/scripyat/public_html/scriptx.in/VehicleMgmt/framework/resources/views/transactions/index-datatable.blade.php ENDPATH**/ ?>