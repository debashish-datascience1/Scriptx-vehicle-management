    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <h5>Vendor Name : <strong><?php echo e($vendor_name); ?></strong> &nbsp;&nbsp;&nbsp; |&nbsp;&nbsp;&nbsp;  Fuel Type : <strong><?php echo e($fuel_name); ?></strong></h5>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
...
</html><?php /**PATH /var/www/html/VehicleMgmt/framework/resources/views/fuel/fuelDetails-print.blade.php ENDPATH**/ ?>